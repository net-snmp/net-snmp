...
int read_view_database __UCD_P((char *));

void view_destroyEntry __UCD_P((int, oid *, int));

struct viewEntry *
view_getEntry __UCD_P((int, oid*, int));
/*
...
struct viewEntry *
view_createEntry __UCD_P((int, oid *, int));
/*
