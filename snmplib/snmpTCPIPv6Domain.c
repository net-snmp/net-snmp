...
oid             netsnmp_TCPIPv6Domain[9] = { ENTERPRISE_MIB, 3, 3, 5 };
...
char           *
snmp_tcp6_fmtaddr(netsnmp_transport *t, void *data, int len)
{
...
int
snmp_tcp6_recv(netsnmp_transport *t, void *buf, int size,
...
int
snmp_tcp6_send(netsnmp_transport *t, void *buf, int size,
               void **opaque, int *olength)
{
    int             rc = 0;
...
int
snmp_tcp6_close(netsnmp_transport *t)
{
    int             rc = 0;
    if (t != NULL && t->sock >= 0) {
...
netsnmp_tcp6_transport(struct sockaddr_in6 *addr, int local)
{
    ...
    string =
        snmp_tcp6_fmtaddr(NULL, (void *) addr,
...
netsnmp_transport *
snmp_tcp6_create_tstring(const char *string, int local)
{
...
netsnmp_transport *
snmp_tcp6_create_ostring(const u_char * o, size_t o_len, int local)
{
    struct sockaddr_in6 addr;
