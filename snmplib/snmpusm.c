...
usm_create_user_from_session(netsnmp_session * session)
{
    ...
    /*
     * if boot/time supplied set it for this engineID, do it from hook when creating
     * user in case probe was sent by other means for example asynchronously.
     */
    if (0 == (session->flags & SNMP_FLAGS_TIME_CREATED) &&
