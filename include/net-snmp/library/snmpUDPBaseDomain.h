 ...
 * Prototypes
 */
    void _netsnmp_udp_sockopt_set(int sock, int local);
    ...
    int netsnmp_udpbase_recvfrom(int sock, void *buf, int len,
                                 struct sockaddr *from, socklen_t *fromlen,
                                 struct sockaddr *dstip, socklen_t *dstlen,
                                 int *if_index);
    int netsnmp_udpbase_sendto(int sock, const struct in_addr *srcip,
