...
#------------------------------------ -o-
STARTAGENT() {
    COMMAND="snmpd -p $SNMP_SNMPD_PORT $SNMP_FLAGS -r -P $SNMP_SNMPD_PID_FILE -l $SNMP_SNMPD_LOG_FILE $AGENT_FLAGS"
...
#------------------------------------ -o-
STARTTRAPD() {
    COMMAND="snmptrapd -d -p $SNMP_SNMPTRAPD_PORT -u $SNMP_SNMPTRAPD_PID_FILE -o $SNMP_SNMPTRAPD_LOG_FILE"
