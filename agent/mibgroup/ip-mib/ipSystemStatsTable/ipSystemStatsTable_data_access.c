                             ...
                             ipSystemStatsTable_reg)
{
    static unsigned int my_columns[] = {
        COLUMN_IPSYSTEMSTATSINRECEIVES,
        COLUMN_IPSYSTEMSTATSHCINRECEIVES,
        ...
        COLUMN_IPSYSTEMSTATSREASMFAILS,
        COLUMN_IPSYSTEMSTATSINDISCARDS,
        COLUMN_IPSYSTEMSTATSINDELIVERS,
        COLUMN_IPSYSTEMSTATSHCINDELIVERS,
        COLUMN_IPSYSTEMSTATSOUTREQUESTS,
        COLUMN_IPSYSTEMSTATSHCOUTREQUESTS,
        COLUMN_IPSYSTEMSTATSOUTNOROUTES,
        ...
        COLUMN_IPSYSTEMSTATSOUTFRAGOKS,
        COLUMN_IPSYSTEMSTATSOUTFRAGFAILS,
