                             ...
                             ipSystemStatsTable_reg)
{
    static unsigned int my_columns[] = {
        ...
        /*COLUMN_IPSYSTEMSTATSINOCTETS*/  COLUMN_IPSYSTEMSTATSHCINOCTETS,
        COLUMN_IPSYSTEMSTATSINHDRERRORS,
        /*COLUMN_IPSYSTEMSTATSINNOROUTES*/
        COLUMN_IPSYSTEMSTATSINADDRERRORS, COLUMN_IPSYSTEMSTATSINUNKNOWNPROTOS,
        /*COLUMN_IPSYSTEMSTATSINTRUNCATEDPKTS*/
        COLUMN_IPSYSTEMSTATSINFORWDATAGRAMS,
        COLUMN_IPSYSTEMSTATSHCINFORWDATAGRAMS, COLUMN_IPSYSTEMSTATSREASMREQDS,
        ...
        /*COLUMN_IPSYSTEMSTATSOUTFORWDATAGRAMS*/ COLUMN_IPSYSTEMSTATSHCOUTFORWDATAGRAMS,
    ...
    DEBUGMSGTL(("verbose:ipSystemStatsTable_init_data", "called\n"));
...
ipSystemStatsTable_container_init(netsnmp_container ** container_ptr_ptr,
                                  netsnmp_cache * cache)
{
    DEBUGMSGTL(("verbose:ipSystemStatsTable_container_init", "called\n"));
    ...
    *container_ptr_ptr = NULL;
     ...
     * by the MFD helper.
     */
    cache->timeout = ipss_cache_refresh;        /* seconds */
...
ipSystemStatsTable_cache_load(netsnmp_container * container)
{
    ...
    DEBUGMSGTL(("verbose:ipSystemStatsTable_cache_load", "called\n"));
                   ...
                   netsnmp_container *stats)
{
    ...
    netsnmp_systemstats_entry *
        systemstats_entry = CONTAINER_FIND(stats, rowreq_ctx->data);
    ...
    if ((NULL != rowreq_ctx) &&
        (MFD_SUCCESS ==
         ipSystemStatsTable_indexes_set(rowreq_ctx,
                                        systemstats_entry->ns_ip_version))) {
...
{
    DEBUGMSGTL(("verbose:ipSystemStatsTable_cache_free", "called\n"));
}
...
{
    DEBUGMSGTL(("verbose:ipSystemStatsTable_row_prep", "called\n"));
