...
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable_init_data", "called\n"));
...
inetNetToMediaTable_container_init(netsnmp_container ** container_ptr_ptr,
                                   netsnmp_cache * cache)
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable_container_init", "called\n"));
...
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable_cache_free", "called\n"));
}
...
{
    DEBUGMSGTL(("verbose:inetNetToMediaTable_row_prep", "called\n"));
