    ...
    (inetNetToMediaTable_registration_ptr reg_ptr, u_long flags)
{
    ...
    DEBUGMSGTL(("internal:_inetNetToMediaTable_initialize_interface",
                "called\n"));
                                 ...
                                 inetNetToMediaTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:inetNetToMediaTable_index_to_oid", "called\n"));
                                   ...
                                   inetNetToMediaTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:inetNetToMediaTable_index_from_oid", "called\n"));
...
inetNetToMediaTable_allocate_rowreq_ctx(inetNetToMediaTable_data * data)
{
    ...
    DEBUGMSGTL(("internal:inetNetToMediaTable_allocate_rowreq_ctx",
                "called\n"));
...
inetNetToMediaTable_release_rowreq_ctx(inetNetToMediaTable_rowreq_ctx *
                                       rowreq_ctx)
{
    DEBUGMSGTL(("internal:inetNetToMediaTable_release_rowreq_ctx",
                "called\n"));
                                       ...
                                       netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetNetToMediaTable_object_lookup",
                "called\n"));
                                ...
                                int column)
{
    ...
    DEBUGMSGTL(("internal:_inetNetToMediaTable_get_column", "called\n"));
                                    ...
                                    netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetNetToMediaTable_get_values",
                "called\n"));
                                  ...
                                  int column)
{
    ...
    DEBUGMSGTL(("internal:_inetNetToMediaTable_check_column", "called\n"));
                                       ...
                                       netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetNetToMediaTable_check_objects",
                "called\n"));
                                   ...
                                   rowreq_ctx)
{
    ...
    DEBUGMSGTL(("internal:_inetNetToMediaTable_check_indexes",
                "called\n"));
                                            ...
                                            netsnmp_request_info *requests)
{
    inetNetToMediaTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    DEBUGMSGTL(("internal:_mfd_inetNetToMediaTable_check_dependencies",
                "called\n"));
 ...
 */
int
_mfd_inetNetToMediaTable_undo_cleanup(netsnmp_mib_handler *handler,
                                      netsnmp_handler_registration
                                      *reginfo,
                                      netsnmp_agent_request_info
                                      *agtreq_info,
                                ...
                                int column)
{
    ...
    DEBUGMSGTL(("internal:_inetNetToMediaTable_set_column", "called\n"));
                                    ...
                                    netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetNetToMediaTable_set_values",
                "called\n"));
                                     ...
                                     netsnmp_request_info *requests)
{
    inetNetToMediaTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    netsnmp_assert(NULL != rowreq_ctx);
    return inetNetToMediaTable_undo_commit(rowreq_ctx);
}
                                 ...
                                 int column)
{
    ...
    DEBUGMSGTL(("internal:_inetNetToMediaTable_undo_column", "called\n"));
                                     ...
                                     netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetNetToMediaTable_undo_values",
                "called\n"));
