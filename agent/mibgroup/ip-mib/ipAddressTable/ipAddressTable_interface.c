                                     ...
                                     reg_ptr, u_long flags)
{
    ...
    DEBUGMSGTL(("internal:_ipAddressTable_initialize_interface",
                "called\n"));
                            ...
                            ipAddressTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:ipAddressTable_index_to_oid", "called\n"));
                              ...
                              ipAddressTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:ipAddressTable_index_from_oid", "called\n"));
...
ipAddressTable_allocate_rowreq_ctx(ipAddressTable_data * data)
{
    ...
    DEBUGMSGTL(("internal:ipAddressTable_allocate_rowreq_ctx",
                "called\n"));
...
{
    DEBUGMSGTL(("internal:ipAddressTable_release_rowreq_ctx", "called\n"));
                                  ...
                                  netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ipAddressTable_object_lookup", "called\n"));
                           ...
                           netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_ipAddressTable_get_column", "called\n"));
                               ...
                               netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ipAddressTable_get_values", "called\n"));
                             ...
                             netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_ipAddressTable_check_column", "called\n"));
                                  ...
                                  netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ipAddressTable_check_objects", "called\n"));
...
_ipAddressTable_check_indexes(ipAddressTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL(("internal:_ipAddressTable_check_indexes", "called\n"));
 ...
 */
static int
_mfd_ipAddressTable_check_dependencies(netsnmp_mib_handler *handler,
                                       ...
                                       netsnmp_request_info *requests)
{
    ipAddressTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    DEBUGMSGTL(("internal:_mfd_ipAddressTable_check_dependencies",
                "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    return ipAddressTable_check_dependencies(rowreq_ctx);
}
                               ...
                               netsnmp_request_info *requests)
{
    ...
    return ipAddressTable_undo_setup(rowreq_ctx);
}
                           ...
                           netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_ipAddressTable_set_column", "called\n"));
                               ...
                               netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ipAddressTable_set_values", "called\n"));
                           ...
                           netsnmp_request_info *requests)
{
    ipAddressTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    netsnmp_assert(NULL != rowreq_ctx);
    return ipAddressTable_commit(rowreq_ctx);
}
                                ...
                                netsnmp_request_info *requests)
{
    ipAddressTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    netsnmp_assert(NULL != rowreq_ctx);
    return ipAddressTable_undo_commit(rowreq_ctx);
}
                            ...
                            netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_ipAddressTable_undo_column", "called\n"));
                                ...
                                netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ipAddressTable_undo_values", "called\n"));
    ...
    for (; requests; requests = requests->next) {
        ...
        _ipAddressTable_undo_column(rowreq_ctx, requests->requestvb,
                                    tri->colnum);
