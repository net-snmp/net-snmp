...
ipAddressTable_init_data(ipAddressTable_registration_ptr
                         ipAddressTable_reg)
{
    DEBUGMSGTL(("verbose:ipAddressTable_init_data", "called\n"));
...
ipAddressTable_container_init(netsnmp_container ** container_ptr_ptr,
                              netsnmp_cache * cache)
{
    DEBUGMSGTL(("verbose:ipAddressTable_container_init", "called\n"));
...
{
    DEBUGMSGTL(("verbose:ipAddressTable_cache_free", "called\n"));
}
...
{
    DEBUGMSGTL(("verbose:ipAddressTable_row_prep", "called\n"));
