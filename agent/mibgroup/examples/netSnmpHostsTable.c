                          ...
                          netsnmp_request_info *requests)
{
    ...
    for (request = requests; request; request = request->next) {
        ...
        case MODE_SET_RESERVE1:
            /*
             * XXX: in the future maybe do row allocs here for creation? 
             */
            break;
        ...
        case MODE_SET_ACTION:
            ...
            case COLUMN_NETSNMPHOSTADDRESSTYPE:
                {
                    int             ret;
                    ret = set_netSnmpHostAddressType(data_context,
                                                     (long *) request->
                                                     requestvb->val.string,
                                                     request->requestvb->
                                                     val_len);
            ...
            case COLUMN_NETSNMPHOSTADDRESS:
                {
                    int             ret;
                    ret = set_netSnmpHostAddress(data_context,
                                                 (char *) request->
                                                 requestvb->val.string,
                                                 request->requestvb->
                                                 val_len);
            ...
            case COLUMN_NETSNMPHOSTSTORAGE:
                {
                    int             ret;
                    ret = set_netSnmpHostStorage(data_context,
                                                 (long *) request->
                                                 requestvb->val.string,
                                                 request->requestvb->
                                                 val_len);
            ...
            case COLUMN_NETSNMPHOSTROWSTATUS:
                {
                    int             ret;
                    ret = set_netSnmpHostRowStatus(data_context,
                                                   (long *) request->
                                                   requestvb->val.string,
                                                   request->requestvb->
                                                   val_len);
        ...
        case MODE_SET_COMMIT:
            {
                void           *data;
                data = netsnmp_oid_stash_get_data(commitStorage,
                                                  suffix + 1,
                                                  suffix_len - 1);
                if (!data) {
                    /** do this once per row only */
                    netSnmpHostsTable_commit_row(&data_context);
            ...
            case COLUMN_NETSNMPHOSTADDRESSTYPE:
                {
                    ...
                    ui = netsnmp_oid_stash_get_data(undoStorage,
                                                    suffix, suffix_len);
                    retval =
                        set_netSnmpHostAddressType(data_context, ui->ptr,
                                                   ui->len);
                    if (retval) {
                        netsnmp_set_request_error(reqinfo, request,
                                                  SNMP_ERR_UNDOFAILED);
            ...
            case COLUMN_NETSNMPHOSTADDRESS:
                {
                    ...
                    ui = netsnmp_oid_stash_get_data(undoStorage,
                                                    suffix, suffix_len);
                    retval =
                        set_netSnmpHostAddress(data_context, ui->ptr,
                                               ui->len);
                    if (retval) {
                        netsnmp_set_request_error(reqinfo, request,
                                                  SNMP_ERR_UNDOFAILED);
            ...
            case COLUMN_NETSNMPHOSTSTORAGE:
                {
                    ...
                    ui = netsnmp_oid_stash_get_data(undoStorage,
                                                    suffix, suffix_len);
                    retval =
                        set_netSnmpHostStorage(data_context, ui->ptr,
                                               ui->len);
                    if (retval) {
                        netsnmp_set_request_error(reqinfo, request,
                                                  SNMP_ERR_UNDOFAILED);
            ...
            case COLUMN_NETSNMPHOSTROWSTATUS:
                {
                    ...
                    ui = netsnmp_oid_stash_get_data(undoStorage,
                                                    suffix, suffix_len);
                    retval =
                        set_netSnmpHostRowStatus(data_context, ui->ptr,
                                                 ui->len);
                    if (retval) {
                        netsnmp_set_request_error(reqinfo, request,
                                                  SNMP_ERR_UNDOFAILED);
    ...
    case MODE_SET_COMMIT:
        ...
        netsnmp_oid_stash_free(&undoStorage, netSnmpHostsTable_free_undoInfo);
