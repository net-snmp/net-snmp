 ...
 *       version : 1.26 $ of : mfd-interface.m2c,v $ 
 *
 * $Id$
 */
/*
                               ...
                               u_long flags)
{
    ...
    DEBUGMSGTL(("internal:_ifXTable_initialize_interface", "called\n"));
    ...
    access_multiplexer->commit = _mfd_ifXTable_undo_commit;
                      ...
                      ifXTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:ifXTable_index_to_oid", "called\n"));
                        ...
                        ifXTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:ifXTable_index_from_oid", "called\n"));
                            ...
                            netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ifXTable_object_lookup", "called\n"));
                     ...
                     netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_ifXTable_get_column", "called\n"));
                         ...
                         netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ifXTable_get_values", "called\n"));
                       ...
                       netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_ifXTable_check_column", "called\n"));
                            ...
                            netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ifXTable_check_objects", "called\n"));
                                 ...
                                 netsnmp_request_info *requests)
{
    ifXTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    DEBUGMSGTL(("internal:_mfd_ifXTable_check_dependencies", "called\n"));
...
ifXTable_undo_setup(ifXTable_rowreq_ctx * rowreq_ctx)
{
    ...
    DEBUGMSGTL(("internal:ifXTable_undo_setup", "called\n"));
...
ifXTable_undo_cleanup(ifXTable_rowreq_ctx * rowreq_ctx)
{
     ...
     */
    DEBUGMSGTL(("internal:ifXTable_undo_cleanup", "called\n"));
                     ...
                     netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_ifXTable_set_column", "called\n"));
                         ...
                         netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ifXTable_set_values", "called\n"));
                          ...
                          netsnmp_request_info *requests)
{
    ifXTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    netsnmp_assert(NULL != rowreq_ctx);
    return ifXTable_undo_commit(rowreq_ctx);
}
                      ...
                      netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_ifXTable_undo_column", "called\n"));
                          ...
                          netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ifXTable_undo_values", "called\n"));
...
_ifXTable_container_init(ifXTable_interface_ctx * if_ctx)
{
    ...
    if (NULL != if_ctx->cache) {
        ...
        snmp_log(LOG_ERR, "error finding cache for ifTable\n");
    }
}
