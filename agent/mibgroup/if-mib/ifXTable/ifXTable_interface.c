 ...
 *       version : 1.29 $ of : mfd-interface.m2c,v $ 
 *
 * $Id$
 */
/*
...
static ifXTable_data *ifXTable_allocate_data(void);
                               ...
                               u_long flags)
{
     ...
     */
    ifXTable_init_data(user_context);
...
ifXTable_allocate_data(void)
{
    ...
    DEBUGMSGTL(("verbose:ifXTable_allocate_data", "called\n"));
...
{
    DEBUGMSGTL(("verbose:ifXTable_release_data", "called\n"));
