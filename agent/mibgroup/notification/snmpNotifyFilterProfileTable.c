...
oid snmpNotifyFilterProfileTable_variables_oid[] = { 1,3,6,1,6,3,13,1,2 };
...
#define   SNMPNOTIFYFILTERPROFILENAME  3
  { SNMPNOTIFYFILTERPROFILENAME, ASN_OCTET_STR , RWRITE, var_snmpNotifyFilterProfileTable, 2, { 1,1 } },
#define   SNMPNOTIFYFILTERPROFILESTORTYPE  4
  { SNMPNOTIFYFILTERPROFILESTORTYPE, ASN_INTEGER   , RWRITE, var_snmpNotifyFilterProfileTable, 2, { 1,2 } },
#define   SNMPNOTIFYFILTERPROFILEROWSTATUS  5
  { SNMPNOTIFYFILTERPROFILEROWSTATUS, ASN_INTEGER   , RWRITE, var_snmpNotifyFilterProfileTable, 2, { 1,3 } },
...
void init_snmpNotifyFilterProfileTable(void) {
  ...
  snmpd_register_config_handler("snmpNotifyFilterProfileTable",
                                parse_snmpNotifyFilterProfileTable, NULL, NULL);
...
snmpNotifyFilterProfileTable_add(struct snmpNotifyFilterProfileTable_data *thedata) {
 ...
 /* add the index variables to the varbind list, which is 
  ...
  header_complex_add_data(&snmpNotifyFilterProfileTableStorage, vars, thedata);
...
parse_snmpNotifyFilterProfileTable(const char *token, char *line) {
  ...
  line = read_config_read_data(ASN_OCTET_STR, line, &StorageTmp->snmpTargetParamsName, &StorageTmp->snmpTargetParamsNameLen);
  ...
  line = read_config_read_data(ASN_INTEGER, line, &StorageTmp->snmpNotifyFilterProfileStorType, &tmpint);

  line = read_config_read_data(ASN_INTEGER, line, &StorageTmp->snmpNotifyFilterProfileRowStatus, &tmpint);
...
store_snmpNotifyFilterProfileTable(int majorID, int minorID,
  ...
  for(hcindex=snmpNotifyFilterProfileTableStorage; hcindex != NULL; 
      ...
      if (StorageTmp->snmpNotifyFilterProfileStorType ==
          ST_NONVOLATILE) {
          ...
          cptr = read_config_store_data(ASN_OCTET_STR, cptr, &StorageTmp->snmpTargetParamsName, &StorageTmp->snmpTargetParamsNameLen);
          ...
          cptr = read_config_store_data(ASN_INTEGER, cptr, &StorageTmp->snmpNotifyFilterProfileStorType, &tmpint);
          cptr = read_config_store_data(ASN_INTEGER, cptr, &StorageTmp->snmpNotifyFilterProfileRowStatus, &tmpint);
    	    ...
    	    WriteMethod **write_method)
{
  ...
  DEBUGMSGTL(("snmpNotifyFilterProfileTable", "var_snmpNotifyFilterProfileTable: Entering...  \n"));
  /* 
   * this assumes you have registered all your data properly
   */
  if ((StorageTmp = (struct snmpNotifyFilterProfileTable_data *)
       header_complex((struct header_complex_index *)snmpNotifyFilterProfileTableStorage, vp,name,length,exact,
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("snmpNotifyFilterProfileTable", "write_snmpNotifyFilterProfileName entering action=%d...  \n", action));
  if ((StorageTmp = (struct snmpNotifyFilterProfileTable_data *)
       header_complex((struct header_complex_index *)snmpNotifyFilterProfileTableStorage, NULL,
                      &name[sizeof(snmpNotifyFilterProfileTable_variables_oid)/sizeof(oid) + 3 - 1], 
  ...
  switch ( action ) {
        case RESERVE1:
          if (var_val_type != ASN_OCTET_STR){
              fprintf(stderr, "write to snmpNotifyFilterProfileName not ASN_OCTET_STR\n");
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->snmpNotifyFilterProfileName, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("snmpNotifyFilterProfileTable", "write_snmpNotifyFilterProfileStorType entering action=%d...  \n", action));
  if ((StorageTmp = (struct snmpNotifyFilterProfileTable_data *)
       header_complex((struct header_complex_index *)snmpNotifyFilterProfileTableStorage, NULL,
                      &name[sizeof(snmpNotifyFilterProfileTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        case RESERVE1:
          if (var_val_type != ASN_INTEGER){
              fprintf(stderr, "write to snmpNotifyFilterProfileStorType not ASN_INTEGER\n");
              return SNMP_ERR_WRONGTYPE;
          }
          break;
...
{
  struct snmpNotifyFilterProfileTable_data *StorageTmp = NULL;
  static struct snmpNotifyFilterProfileTable_data *StorageNew, *StorageDel;
  size_t newlen=name_len - (sizeof(snmpNotifyFilterProfileTable_variables_oid)/sizeof(oid) + 3 - 1);
  ...
  if (var_val_type != ASN_INTEGER || var_val == NULL){
    fprintf(stderr, "write to snmpNotifyFilterProfileRowStatus not ASN_INTEGER\n");
    return SNMP_ERR_WRONGTYPE;
  }
    ...
    /* XXX: interaction with row storage type needed */
        ...
        case RESERVE2:
          ...
          if (StorageTmp == NULL &&
            ...
            snmp_varlist_add_variable(&vars, NULL, 0, ASN_PRIV_IMPLIED_OCTET_STR, NULL, 0);

            if (header_complex_parse_oid(&(name[sizeof(snmpNotifyFilterProfileTable_variables_oid)/sizeof(oid)+2]), newlen, vars) != SNMPERR_SUCCESS) {
              snmp_free_var(vars);
        ...
        case COMMIT:
          ...
          if (StorageTmp && StorageTmp->snmpNotifyFilterProfileRowStatus == RS_CREATEANDGO) {
              StorageTmp->snmpNotifyFilterProfileRowStatus = RS_ACTIVE;
                     ...
                     StorageTmp->snmpNotifyFilterProfileRowStatus == RS_CREATEANDWAIT) {
