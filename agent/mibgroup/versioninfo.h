...
unsigned char *var_extensible_version __UCD_P((struct variable *, oid *, int *, int, int *, int (**write) __UCD_P((int, u_char *, u_char, int, u_char *, oid *, int)) ));
int update_hook __UCD_P((int, u_char *, u_char, int, u_char *, oid *,int));
