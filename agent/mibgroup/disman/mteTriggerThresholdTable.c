...
oid mteTriggerThresholdTable_variables_oid[] = { 1,3,6,1,2,1,88,1,2,6 };
...
#define   MTETRIGGERTHRESHOLDSTARTUP  3
  { MTETRIGGERTHRESHOLDSTARTUP, ASN_INTEGER   , RWRITE, var_mteTriggerThresholdTable, 2, { 1,1 } },
#define   MTETRIGGERTHRESHOLDRISING  4
  { MTETRIGGERTHRESHOLDRISING, ASN_INTEGER   , RWRITE, var_mteTriggerThresholdTable, 2, { 1,2 } },
#define   MTETRIGGERTHRESHOLDFALLING  5
  { MTETRIGGERTHRESHOLDFALLING, ASN_INTEGER   , RWRITE, var_mteTriggerThresholdTable, 2, { 1,3 } },
#define   MTETRIGGERTHRESHOLDDELTARISING  6
  { MTETRIGGERTHRESHOLDDELTARISING, ASN_INTEGER   , RWRITE, var_mteTriggerThresholdTable, 2, { 1,4 } },
#define   MTETRIGGERTHRESHOLDDELTAFALLING  7
  { MTETRIGGERTHRESHOLDDELTAFALLING, ASN_INTEGER   , RWRITE, var_mteTriggerThresholdTable, 2, { 1,5 } },
#define   MTETRIGGERTHRESHOLDOBJECTSOWNER  8
  { MTETRIGGERTHRESHOLDOBJECTSOWNER, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,6 } },
#define   MTETRIGGERTHRESHOLDOBJECTS  9
  { MTETRIGGERTHRESHOLDOBJECTS, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,7 } },
#define   MTETRIGGERTHRESHOLDRISINGEVENTOWNER  10
  { MTETRIGGERTHRESHOLDRISINGEVENTOWNER, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,8 } },
#define   MTETRIGGERTHRESHOLDRISINGEVENT  11
  { MTETRIGGERTHRESHOLDRISINGEVENT, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,9 } },
#define   MTETRIGGERTHRESHOLDFALLINGEVENTOWNER  12
  { MTETRIGGERTHRESHOLDFALLINGEVENTOWNER, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,10 } },
#define   MTETRIGGERTHRESHOLDFALLINGEVENT  13
  { MTETRIGGERTHRESHOLDFALLINGEVENT, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,11 } },
#define   MTETRIGGERTHRESHOLDDELTARISINGEVENTOWNER  14
  { MTETRIGGERTHRESHOLDDELTARISINGEVENTOWNER, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,12 } },
#define   MTETRIGGERTHRESHOLDDELTARISINGEVENT  15
  { MTETRIGGERTHRESHOLDDELTARISINGEVENT, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,13 } },
#define   MTETRIGGERTHRESHOLDDELTAFALLINGEVENTOWNER  16
  { MTETRIGGERTHRESHOLDDELTAFALLINGEVENTOWNER, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,14 } },
#define   MTETRIGGERTHRESHOLDDELTAFALLINGEVENT  17
  { MTETRIGGERTHRESHOLDDELTAFALLINGEVENT, ASN_OCTET_STR , RWRITE, var_mteTriggerThresholdTable, 2, { 1,15 } },
...
void init_mteTriggerThresholdTable(void) {
  ...
  REGISTER_MIB("mteTriggerThresholdTable", mteTriggerThresholdTable_variables, variable2,
               mteTriggerThresholdTable_variables_oid);
...
struct mteTriggerTable_data *StorageTmp = NULL;
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "var_mteTriggerThresholdTable: Entering...  \n"));
  /* 
  ...
  switch(vp->magic) {
    ...
    case MTETRIGGERTHRESHOLDDELTARISINGEVENTOWNER:
        ...
        *var_len = StorageTmp->mteTriggerThresholdDeltaRisingEventOwnerLen;
        return (u_char *) StorageTmp->mteTriggerThresholdDeltaRisingEventOwner;
    ...
    case MTETRIGGERTHRESHOLDDELTAFALLINGEVENTOWNER:
        ...
        *var_len = StorageTmp->mteTriggerThresholdDeltaFallingEventOwnerLen;
        return (u_char *) StorageTmp->mteTriggerThresholdDeltaFallingEventOwner;
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdStartup entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdRising entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdFalling entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdDeltaRising entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdDeltaFalling entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdObjectsOwner entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdObjectsOwner, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdObjects entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdObjects, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdRisingEventOwner entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdRisingEventOwner, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdRisingEvent entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdRisingEvent, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdFallingEventOwner entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdFallingEventOwner, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdFallingEvent entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdFallingEvent, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdDeltaRisingEventOwner entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdDeltaRisingEventOwner, var_val, var_val_len);
             StorageTmp->mteTriggerThresholdDeltaRisingEventOwnerLen = var_val_len;
          break;
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdDeltaRisingEvent entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdDeltaRisingEvent, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdDeltaFallingEventOwner entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdDeltaFallingEventOwner, var_val, var_val_len);
             StorageTmp->mteTriggerThresholdDeltaFallingEventOwnerLen = var_val_len;
          break;
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerThresholdTable", "write_mteTriggerThresholdDeltaFallingEvent entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerThresholdTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerThresholdDeltaFallingEvent, var_val, var_val_len);
