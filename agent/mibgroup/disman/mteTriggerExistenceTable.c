...
oid mteTriggerExistenceTable_variables_oid[] = { 1,3,6,1,2,1,88,1,2,4 };
...
#define   MTETRIGGEREXISTENCETEST  3
  { MTETRIGGEREXISTENCETEST, ASN_BIT_STR   , RWRITE, var_mteTriggerExistenceTable, 2, { 1,1 } },
#define   MTETRIGGEREXISTENCESTARTUP  4
  { MTETRIGGEREXISTENCESTARTUP, ASN_BIT_STR   , RWRITE, var_mteTriggerExistenceTable, 2, { 1,2 } },
#define   MTETRIGGEREXISTENCEOBJECTSOWNER  5
  { MTETRIGGEREXISTENCEOBJECTSOWNER, ASN_OCTET_STR , RWRITE, var_mteTriggerExistenceTable, 2, { 1,3 } },
#define   MTETRIGGEREXISTENCEOBJECTS  6
  { MTETRIGGEREXISTENCEOBJECTS, ASN_OCTET_STR , RWRITE, var_mteTriggerExistenceTable, 2, { 1,4 } },
#define   MTETRIGGEREXISTENCEEVENTOWNER  7
  { MTETRIGGEREXISTENCEEVENTOWNER, ASN_OCTET_STR , RWRITE, var_mteTriggerExistenceTable, 2, { 1,5 } },
#define   MTETRIGGEREXISTENCEEVENT  8
  { MTETRIGGEREXISTENCEEVENT, ASN_OCTET_STR , RWRITE, var_mteTriggerExistenceTable, 2, { 1,6 } },
...
void init_mteTriggerExistenceTable(void) {
  ...
  REGISTER_MIB("mteTriggerExistenceTable", mteTriggerExistenceTable_variables, variable2,
               mteTriggerExistenceTable_variables_oid);
...
struct mteTriggerTable_data *StorageTmp = NULL;
  ...
  DEBUGMSGTL(("mteTriggerExistenceTable", "var_mteTriggerExistenceTable: Entering...  \n"));
  /* 
            ...
            size_t    name_len)
{
  ...
  size_t newlen=name_len - (sizeof(mteTriggerExistenceTable_variables_oid)/sizeof(oid) + 3 - 1);


  DEBUGMSGTL(("mteTriggerExistenceTable", "write_mteTriggerExistenceTest entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerExistenceTable_variables_oid)/sizeof(oid) + 3 - 1], 
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerExistenceTest, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerExistenceTable", "write_mteTriggerExistenceStartup entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerExistenceTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerExistenceStartup, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerExistenceTable", "write_mteTriggerExistenceObjectsOwner entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerExistenceTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerExistenceObjectsOwner, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerExistenceTable", "write_mteTriggerExistenceObjects entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerExistenceTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerExistenceObjects, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerExistenceTable", "write_mteTriggerExistenceEventOwner entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerExistenceTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerExistenceEventOwner, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerExistenceTable", "write_mteTriggerExistenceEvent entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerExistenceTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerExistenceEvent, var_val, var_val_len);
