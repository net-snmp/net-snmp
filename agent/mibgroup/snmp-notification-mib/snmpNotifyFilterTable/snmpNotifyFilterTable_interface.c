 ...
 */
static int
_mfd_snmpNotifyFilterTable_pre_request(netsnmp_mib_handler *handler,
                                       ...
                                       netsnmp_request_info *requests)
{
    ...
    if (MFD_SUCCESS != rc) {
         ...
         */
        DEBUGMSGTL(("internal:snmpNotifyFilterTable", "error %d from "
 ...
 */
static int
_mfd_snmpNotifyFilterTable_post_request(netsnmp_mib_handler *handler,
                                        netsnmp_handler_registration
                                        *reginfo,
                                        netsnmp_agent_request_info
                                        *agtreq_info,
 ...
 */
static int
_mfd_snmpNotifyFilterTable_object_lookup(netsnmp_mib_handler *handler,
                                         netsnmp_handler_registration
                                         *reginfo,
                                         netsnmp_agent_request_info
                                         *agtreq_info,
...
int
_mfd_snmpNotifyFilterTable_get_values(netsnmp_mib_handler *handler,
                                      netsnmp_handler_registration
                                      *reginfo,
                                      netsnmp_agent_request_info
                                      *agtreq_info,
...
int
_mfd_snmpNotifyFilterTable_check_objects(netsnmp_mib_handler *handler,
                                         netsnmp_handler_registration
                                         *reginfo,
                                         netsnmp_agent_request_info
                                         *agtreq_info,
 ...
 */
static int
_mfd_snmpNotifyFilterTable_check_dependencies(netsnmp_mib_handler *handler,
                                              netsnmp_handler_registration
                                              *reginfo,
                                              netsnmp_agent_request_info
                                              *agtreq_info,
                                              ...
                                              *requests)
{
    ...
    if (rc) {
        DEBUGMSGTL(("verbose:snmpNotifyFilterTable:mfd", "error %d from "
 ...
 */
int
_mfd_snmpNotifyFilterTable_undo_setup(netsnmp_mib_handler *handler,
                                      netsnmp_handler_registration
                                      *reginfo,
                                      netsnmp_agent_request_info
                                      *agtreq_info,
    ...
    if (MFD_SUCCESS != rc) {
        ...
        for (; requests; requests = requests->next) {
            ...
            rc = _snmpNotifyFilterTable_undo_setup_column(rowreq_ctx,
                                                          tri->colnum);
            if (MFD_SUCCESS != rc) {
                DEBUGMSGTL(("verbose:snmpNotifyFilterTable:mfd",
                            "error %d from "
 ...
 */
int
_mfd_snmpNotifyFilterTable_undo_cleanup(netsnmp_mib_handler *handler,
                                        netsnmp_handler_registration
                                        *reginfo,
                                        netsnmp_agent_request_info
                                        *agtreq_info,
...
int
_mfd_snmpNotifyFilterTable_set_values(netsnmp_mib_handler *handler,
                                      netsnmp_handler_registration
                                      *reginfo,
                                      netsnmp_agent_request_info
                                      *agtreq_info,
...
int
_mfd_snmpNotifyFilterTable_undo_commit(netsnmp_mib_handler *handler,
                                       netsnmp_handler_registration
                                       *reginfo,
                                       netsnmp_agent_request_info
                                       *agtreq_info,
...
int
_mfd_snmpNotifyFilterTable_undo_values(netsnmp_mib_handler *handler,
                                       netsnmp_handler_registration
                                       *reginfo,
                                       netsnmp_agent_request_info
                                       *agtreq_info,
