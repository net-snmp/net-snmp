...
static const struct stats_descr ipv4_snmp_stats[] = {
    { "Ip:", "Forwarding", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipForwarding) },
    { "Ip:", "DefaultTTL", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipDefaultTTL) },
    { "Ip:", "InReceives", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipInReceives) },
    { "Ip:", "InHdrErrors", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipInHdrErrors) },
    { "Ip:", "InAddrErrors", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipInAddrErrors) },
    { "Ip:", "ForwDatagrams", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipForwDatagrams) },
    { "Ip:", "InUnknownProtos", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipInUnknownProtos) },
    { "Ip:", "InDiscards", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipInDiscards) },
    { "Ip:", "InDelivers", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipInDelivers) },
    { "Ip:", "OutRequests", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipOutRequests) },
    { "Ip:", "OutDiscards", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipOutDiscards) },
    { "Ip:", "OutNoRoutes", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipOutNoRoutes) },
    { "Ip:", "ReasmTimeout", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipReasmTimeout) },
    { "Ip:", "ReasmReqds", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipReasmReqds) },
    { "Ip:", "ReasmOKs", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipReasmOKs) },
    { "Ip:", "ReasmFails", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipReasmFails) },
    { "Ip:", "FragOKs", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipFragOKs) },
    { "Ip:", "FragFails", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipFragFails) },
    { "Ip:", "FragCreates", &cached_ip_mib,
      offsetof(typeof(cached_ip_mib), ipFragCreates) },

    { "Icmp:", "InMsgs", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInMsgs) },
    { "Icmp:", "InErrors", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInErrors) },
    { "Icmp:", "InDestUnreachs", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInDestUnreachs) },
    { "Icmp:", "InTimeExcds", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInTimeExcds) },
    { "Icmp:", "InParmProbs", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInParmProbs) },
    { "Icmp:", "InSrcQuenchs", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInSrcQuenchs) },
    { "Icmp:", "InRedirects", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInRedirects) },
    { "Icmp:", "InEchos", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInEchos) },
    { "Icmp:", "InEchoReps", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInEchoReps) },
    { "Icmp:", "InTimestamps", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInTimestamps) },
    { "Icmp:", "InTimestampReps", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInTimestampReps) },
    { "Icmp:", "InAddrMasks", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInAddrMasks) },
    { "Icmp:", "InAddrMaskReps", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpInAddrMaskReps) },
    { "Icmp:", "OutMsgs", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutMsgs) },
    { "Icmp:", "OutErrors", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutErrors) },
    { "Icmp:", "OutDestUnreachs", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutDestUnreachs) },
    { "Icmp:", "OutTimeExcds", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutTimeExcds) },
    { "Icmp:", "OutParmProbs", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutParmProbs) },
    { "Icmp:", "OutSrcQuenchs", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutSrcQuenchs) },
    { "Icmp:", "OutRedirects", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutRedirects) },
    { "Icmp:", "OutEchos", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutEchos) },
    { "Icmp:", "OutEchoReps", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutEchoReps) },
    { "Icmp:", "OutTimestamps", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutTimestamps) },
    { "Icmp:", "OutTimestampReps", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutTimestampReps) },
    { "Icmp:", "OutAddrMasks", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutAddrMasks) },
    { "Icmp:", "OutAddrMaskReps", &cached_icmp_mib,
      offsetof(typeof(cached_icmp_mib), icmpOutAddrMaskReps) },

    { "Tcp:", "RtoAlgorithm", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpRtoAlgorithm) },
    { "Tcp:", "RtoMin", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpRtoMin) },
    { "Tcp:", "RtoMax", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpRtoMax) },
    { "Tcp:", "MaxConn", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpMaxConn) },
    { "Tcp:", "ActiveOpens", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpActiveOpens) },
    { "Tcp:", "PassiveOpens", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpPassiveOpens) },
    { "Tcp:", "AttemptFails", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpAttemptFails) },
    { "Tcp:", "EstabResets", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpEstabResets) },
    { "Tcp:", "CurrEstab", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpCurrEstab) },
    { "Tcp:", "InSegs", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpInSegs) },
    { "Tcp:", "OutSegs", &cached_tcp_mib,
      offsetof(typeof(cached_tcp_mib), tcpOutSegs) },
    ...
    { "Udp:", "NoPorts", &cached_udp_mib,
      offsetof(typeof(cached_udp_mib), udpNoPorts) },
    { "Udp:", "InErrors", &cached_udp_mib,
      offsetof(typeof(cached_udp_mib), udpInErrors) },
    { "Udp:", "OutDatagrams", &cached_udp_mib,
      offsetof(typeof(cached_udp_mib), udpOutDatagrams) },
};
