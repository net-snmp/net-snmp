...
{
    DEBUGMSGTL(("verbose:inetCidrRouteTable_init_data", "called\n"));
...
inetCidrRouteTable_container_init(netsnmp_container ** container_ptr_ptr,
                                  netsnmp_cache * cache)
{
    DEBUGMSGTL(("verbose:inetCidrRouteTable_container_init", "called\n"));
...
{
    DEBUGMSGTL(("verbose:inetCidrRouteTable_cache_free", "called\n"));
}
...
{
    DEBUGMSGTL(("verbose:inetCidrRouteTable_row_prep", "called\n"));
