 ...
 * *
 * * Revision 1.7  2002/04/20 07:07:36  hardaker
 ...
 * * change // coments to /* 
 */ comments(bad bad bad)
* *Revision 1.5 2002 / 02 / 08 15: 45: 09 dts12 * Use the new 'net-snmp-includes' single - include header files, *in place of the(uninstalled) 'mibincl.h'. * Wheeeee...... * *Revision 1.4 2002 / 02 / 05 17: 54: 16 hardaker * Patch from Harrie Hazewinkel to move the oidtree_compare function to * the main library. * *Revision 1.3 2002 / 01 / 29 04: 54: 50 hardaker * Major file moving and editing of include directives. * -essentially adds up to:
