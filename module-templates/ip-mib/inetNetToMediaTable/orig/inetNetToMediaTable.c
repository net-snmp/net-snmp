                                    ...
                                    rowreq_ctx, void *user_init_ctx)
{
     ...
     */
    rowreq_ctx->data->inetNetToMediaType = INETNETTOMEDIATYPE_STATIC;
...
inetNetToMediaTable_allocate_data(void)
{
    ...
    inetNetToMediaTable_data *rtn =
        SNMP_MALLOC_TYPEDEF(inetNetToMediaTable_data);
                                        ...
                                        inetNetToMediaNetAddress_val_ptr_len)
{
     ...
     */
    if ((NULL == tbl_idx->inetNetToMediaNetAddress) ||
                              ...
                              *inetNetToMediaPhysAddress_val_ptr_len_ptr)
{
   /** we should have a non-NULL pointer and enough storage */
     ...
     */
    /*
     * TODO:235:M: |-> Remove log message/SKIP once you've set inetNetToMediaPhysAddress data
     */
    snmp_log(LOG_ERR,
             "inetNetToMediaTable node inetNetToMediaPhysAddress not implemented: skipping\n");
    return MFD_SKIP;
                              ...
                              u_long * inetNetToMediaLastUpdated_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    /*
     * TODO:235:M: |-> Remove log message/SKIP once you've set inetNetToMediaLastUpdated data
     */
    snmp_log(LOG_ERR,
             "inetNetToMediaTable node inetNetToMediaLastUpdated not implemented: skipping\n");
    return MFD_SKIP;
                       ...
                       u_long * inetNetToMediaType_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    /*
     * TODO:235:M: |-> Remove log message/SKIP once you've set inetNetToMediaType data
     */
    snmp_log(LOG_ERR,
             "inetNetToMediaTable node inetNetToMediaType not implemented: skipping\n");
    return MFD_SKIP;
                        ...
                        u_long * inetNetToMediaState_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    /*
     * TODO:235:M: |-> Remove log message/SKIP once you've set inetNetToMediaState data
     */
    snmp_log(LOG_ERR,
             "inetNetToMediaTable node inetNetToMediaState not implemented: skipping\n");
    return MFD_SKIP;
