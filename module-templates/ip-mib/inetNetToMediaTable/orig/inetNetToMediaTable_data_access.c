...
inetNetToMediaTable_container_load(netsnmp_container * container)
{
    ...
    DEBUGMSGTL(("verbose:inetNetToMediaTable:inetNetToMediaTable_container_load", "called\n"));
    ...
    while (1) {
        ...
        /*
         * TODO:352:M: |   |-> set indexes in new inetNetToMediaTable rowreq context.
         ...
         *      inetNetToMediaTablerowreq_ctx_init.
         */
        ...
        if (MFD_SUCCESS !=
            inetNetToMediaTable_indexes_set(rowreq_ctx,
                                            inetNetToMediaIfIndex,
                                            inetNetToMediaNetAddressType,
                                            inetNetToMediaNetAddress,
                                            inetNetToMediaNetAddress_len))
        {
            snmp_log(LOG_ERR,
                     "error setting index while loading "
                     "inetNetToMediaTable data.\n");
            inetNetToMediaTable_release_rowreq_ctx(rowreq_ctx);
            continue;
        }

        /*
         * TODO:352:r: |   |-> populate inetNetToMediaTable data context.
    ...
    DEBUGMSGT(("verbose:inetNetToMediaTable:inetNetToMediaTable_container_load", "inserted %d records\n", count));
