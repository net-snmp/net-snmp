...
ipSystemStatsTable_container_load(netsnmp_container * container)
{
    ...
    DEBUGMSGTL(("verbose:ipSystemStatsTable:ipSystemStatsTable_container_load", "called\n"));
    ...
    while (1) {
         ...
         *      ipSystemStatsTablerowreq_ctx_init.
         */
        rowreq_ctx = ipSystemStatsTable_allocate_rowreq_ctx(NULL, NULL);
        if (NULL == rowreq_ctx) {
    ...
    DEBUGMSGT(("verbose:ipSystemStatsTable:ipSystemStatsTable_container_load", "inserted %d records\n", count));
