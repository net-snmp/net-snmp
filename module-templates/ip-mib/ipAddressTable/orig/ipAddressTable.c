...
initialize_table_ipAddressTable(void)
{
     ...
     */
    user_context = netsnmp_create_data_list("ipAddressTable", NULL, NULL);
...
ipAddressTable_allocate_data(void)
{
     ...
     */
    ipAddressTable_data *rtn = SNMP_MALLOC_TYPEDEF(ipAddressTable_data);
                      ...
                      u_long raw_ipAddressAddrType_val)
{
    ...
    case INTERNAL_IPADDRESSADDRTYPE_UNKNOWN:
    ...
    case INTERNAL_IPADDRESSADDRTYPE_IPV4Z:
        *mib_ipAddressAddrType_val_ptr = INETADDRESSTYPE_IPV4Z;
        break;

    case INTERNAL_IPADDRESSADDRTYPE_IPV6Z:
        *mib_ipAddressAddrType_val_ptr = INETADDRESSTYPE_IPV6Z;
        break;

    case INTERNAL_IPADDRESSADDRTYPE_DNS:
        *mib_ipAddressAddrType_val_ptr = INETADDRESSTYPE_DNS;
        break;
                     ...
                     long *ipAddressIfIndex_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipAddressIfIndex data */
                  ...
                  u_long * ipAddressType_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipAddressType data */
                    ...
                    size_t *ipAddressPrefix_val_ptr_len_ptr)
{
   /** we should have a non-NULL pointer and enough storage */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipAddressPrefix data */
                    ...
                    u_long * ipAddressOrigin_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipAddressOrigin data */
                    ...
                    u_long * ipAddressStatus_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipAddressStatus data */
                     ...
                     u_long * ipAddressCreated_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipAddressCreated data */
                         ...
                         u_long * ipAddressLastChanged_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipAddressLastChanged data */
                       ...
                       u_long * ipAddressRowStatus_val_ptr)
{
   /** we should have a non-NULL pointer */
    ...
    /** WARNING: this code might not work for netsnmp_ipaddress_entry */
    (*ipAddressRowStatus_val_ptr) = rowreq_ctx->data->ipAddressRowStatus;
                         ...
                         u_long * ipAddressStorageType_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipAddressStorageType data */
...
ipAddressTable_commit(ipAddressTable_rowreq_ctx * rowreq_ctx)
{
    ...
    if (save_flags & FLAG_IPADDRESSIFINDEX) {
        save_flags &= ~FLAG_IPADDRESSIFINDEX;   /* clear ipAddressIfIndex */
        /*
         * TODO:482:o: |-> commit column ipAddressIfIndex.
         */
        rc = -1;
        if (-1 == rc) {
            snmp_log(LOG_ERR,
                     "ipAddressTable column ipAddressIfIndex commit failed\n");
        } else {
            /*
             * set flag, in case we need to undo ipAddressIfIndex
             */
    ...
    if (save_flags & FLAG_IPADDRESSTYPE) {
        save_flags &= ~FLAG_IPADDRESSTYPE;      /* clear ipAddressType */
        /*
         * TODO:482:o: |-> commit column ipAddressType.
         */
        rc = -1;
        if (-1 == rc) {
            snmp_log(LOG_ERR,
                     "ipAddressTable column ipAddressType commit failed\n");
        } else {
            /*
             * set flag, in case we need to undo ipAddressType
             */
    ...
    if (save_flags & FLAG_IPADDRESSSTATUS) {
        save_flags &= ~FLAG_IPADDRESSSTATUS;    /* clear ipAddressStatus */
        /*
         * TODO:482:o: |-> commit column ipAddressStatus.
         */
        rc = -1;
        if (-1 == rc) {
            snmp_log(LOG_ERR,
                     "ipAddressTable column ipAddressStatus commit failed\n");
        } else {
            /*
             * set flag, in case we need to undo ipAddressStatus
             */
    ...
    if (save_flags & FLAG_IPADDRESSROWSTATUS) {
        save_flags &= ~FLAG_IPADDRESSROWSTATUS; /* clear ipAddressRowStatus */
        /*
         * TODO:482:o: |-> commit column ipAddressRowStatus.
         */
        rc = -1;
        if (-1 == rc) {
            snmp_log(LOG_ERR,
                     "ipAddressTable column ipAddressRowStatus commit failed\n");
        } else {
            /*
             * set flag, in case we need to undo ipAddressRowStatus
             */
    ...
    if (save_flags & FLAG_IPADDRESSSTORAGETYPE) {
        save_flags &= ~FLAG_IPADDRESSSTORAGETYPE;       /* clear ipAddressStorageType */
        /*
         * TODO:482:o: |-> commit column ipAddressStorageType.
         */
        rc = -1;
        if (-1 == rc) {
            snmp_log(LOG_ERR,
                     "ipAddressTable column ipAddressStorageType commit failed\n");
        } else {
            /*
             * set flag, in case we need to undo ipAddressStorageType
             */
...
ipAddressTable_check_dependencies(ipAddressTable_rowreq_ctx * rowreq_ctx)
{
    ...
    if (rowreq_ctx->column_set_flags & FLAG_IPADDRESSROWSTATUS) {
        ...
        if (rowreq_ctx->rowreq_flags & MFD_ROW_CREATED) {
             ...
             * can be destroyed.
             */
            if (ROWSTATUS_DESTROY == rowreq_ctx->data->ipAddressRowStatus) {
                if (rowreq_ctx->
     ...
     */
    rc = check_storage_transition(rowreq_ctx->undo->ipAddressStorageType,
                                  rowreq_ctx->data->ipAddressStorageType);
    if (MFD_SUCCESS != rc)
        return rc;
