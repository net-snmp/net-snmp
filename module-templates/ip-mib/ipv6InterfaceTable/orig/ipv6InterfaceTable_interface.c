...
ipv6InterfaceTable_data *ipv6InterfaceTable_allocate_data(void);
 ...
 */
int
ipv6InterfaceTable_index_to_oid(netsnmp_index * oid_idx,
                                ipv6InterfaceTable_mib_index * mib_idx)
{
     ...
     */
    netsnmp_variable_list var_ipv6InterfaceIfIndex;

    /*
     * set up varbinds
     */
    memset(&var_ipv6InterfaceIfIndex, 0x00,
           sizeof(var_ipv6InterfaceIfIndex));
    var_ipv6InterfaceIfIndex.type = ASN_INTEGER;

    /*
     * chain temp index varbinds together
     */
    var_ipv6InterfaceIfIndex.next_variable = NULL;


    DEBUGMSGTL(("verbose:ipv6InterfaceTable:ipv6InterfaceTable_index_to_oid", "called\n"));

    /*
     * ipv6InterfaceIfIndex(1)/InterfaceIndex/ASN_INTEGER/long(long)//l/a/w/e/R/d/H 
     */
    snmp_set_var_value(&var_ipv6InterfaceIfIndex,
                       (u_char *) & mib_idx->ipv6InterfaceIfIndex,
                       sizeof(mib_idx->ipv6InterfaceIfIndex));


    err = build_oid_noalloc(oid_idx->oids, oid_idx->len, &oid_idx->len,
                            NULL, 0, &var_ipv6InterfaceIfIndex);
    if (err)
     ...
     */
    snmp_reset_var_buffers(&var_ipv6InterfaceIfIndex);

    return err;
}                               /* ipv6InterfaceTable_index_to_oid */

/**
 * extract ipv6InterfaceTable indexes from a netsnmp_index
 *
 * @retval SNMP_ERR_NOERROR  : no error
 * @retval SNMP_ERR_GENERR   : error
 */
int
ipv6InterfaceTable_index_from_oid(netsnmp_index * oid_idx,
                                  ipv6InterfaceTable_mib_index * mib_idx)
{
    int             err = SNMP_ERR_NOERROR;
    ...
    DEBUGMSGTL(("verbose:ipv6InterfaceTable:ipv6InterfaceTable_index_from_oid", "called\n"));

    /*
     * parse the oid into the individual index components
     */
    err = parse_oid_indexes(oid_idx->oids, oid_idx->len,
                            &var_ipv6InterfaceIfIndex);
    if (err == SNMP_ERR_NOERROR) {
        /*
         * copy out values
         */
        mib_idx->ipv6InterfaceIfIndex =
            *((long *) var_ipv6InterfaceIfIndex.val.string);
    ...
    return err;
}                               /* ipv6InterfaceTable_index_from_oid */


/*
 * ipv6InterfaceTable_allocate_data
 *
 * Purpose: create new ipv6InterfaceTable_data.
 */
ipv6InterfaceTable_data *
ipv6InterfaceTable_allocate_data(void)
{
    ipv6InterfaceTable_data *rtn =
        SNMP_MALLOC_TYPEDEF(ipv6InterfaceTable_data);

    DEBUGMSGTL(("verbose:ipv6InterfaceTable:ipv6InterfaceTable_allocate_data", "called\n"));
...
/*
 * ipv6InterfaceTable_release_data
 *
 * Purpose: release ipv6InterfaceTable data.
 */
void
ipv6InterfaceTable_release_data(ipv6InterfaceTable_data * data)
{
    DEBUGMSGTL(("verbose:ipv6InterfaceTable:ipv6InterfaceTable_release_data", "called\n"));
 ...
 *********************************************************************
 * @internal
 * allocate resources for a ipv6InterfaceTable_rowreq_ctx
 */
ipv6InterfaceTable_rowreq_ctx *
ipv6InterfaceTable_allocate_rowreq_ctx(void *user_init_ctx)
{
    ipv6InterfaceTable_rowreq_ctx *rowreq_ctx =
        SNMP_MALLOC_TYPEDEF(ipv6InterfaceTable_rowreq_ctx);

    DEBUGMSGTL(("internal:ipv6InterfaceTable:ipv6InterfaceTable_allocate_rowreq_ctx", "called\n"));
    ...
    rowreq_ctx->ipv6InterfaceTable_data_list = NULL;
    ...
    if (!(rowreq_ctx->rowreq_flags & MFD_ROW_DATA_FROM_USER)) {
        if (SNMPERR_SUCCESS !=
            ipv6InterfaceTable_rowreq_ctx_init(rowreq_ctx,
                                               user_init_ctx)) {
    ...
    return rowreq_ctx;
}                               /* ipv6InterfaceTable_allocate_rowreq_ctx */

/*
 * @internal
 * release resources for a ipv6InterfaceTable_rowreq_ctx
 */
void
ipv6InterfaceTable_release_rowreq_ctx(ipv6InterfaceTable_rowreq_ctx *
                                      rowreq_ctx)
{
    DEBUGMSGTL(("internal:ipv6InterfaceTable:ipv6InterfaceTable_release_rowreq_ctx", "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    ipv6InterfaceTable_rowreq_ctx_cleanup(rowreq_ctx);

    if (rowreq_ctx->undo)
        ipv6InterfaceTable_release_data(rowreq_ctx->undo);
...
}                               /* ipv6InterfaceTable_release_rowreq_ctx */
 ...
 */
static int
_mfd_ipv6InterfaceTable_object_lookup(netsnmp_mib_handler *handler,
...
int
_mfd_ipv6InterfaceTable_check_objects(netsnmp_mib_handler *handler,
                                      netsnmp_handler_registration
                                      *reginfo,
                                      netsnmp_agent_request_info
                                      *agtreq_info,
                                   ...
                                   netsnmp_request_info *requests)
{
     ...
     */
    rowreq_ctx->undo = ipv6InterfaceTable_allocate_data();
 ...
 */
int
_mfd_ipv6InterfaceTable_irreversible_commit(netsnmp_mib_handler *handler,
                                            netsnmp_handler_registration
                                            *reginfo,
                                            netsnmp_agent_request_info
                                            *agtreq_info,
 ...
 */
static void
_container_item_free(ipv6InterfaceTable_rowreq_ctx * rowreq_ctx,
                     void *context)
{
    DEBUGMSGTL(("internal:ipv6InterfaceTable:_container_item_free",
                "called\n"));
                                         ...
                                         mib_idx)
{
     ...
     * convert
     */
    rc = ipv6InterfaceTable_index_to_oid(&oid_idx, mib_idx);
    if (MFD_SUCCESS != rc)
        return NULL;
