...
{
    DEBUGMSGTL(("verbose:ipv6InterfaceTable:ipv6InterfaceTable_indexes_set_tbl_idx", "called\n"));

    /*
     * ipv6InterfaceIfIndex(1)/InterfaceIndex/ASN_INTEGER/long(long)//l/a/w/e/R/d/H 
     */
    tbl_idx->ipv6InterfaceIfIndex = ipv6InterfaceIfIndex_val;


    return MFD_SUCCESS;
}                               /* ipv6InterfaceTable_indexes_set_tbl_idx */
 ...
 */
int
ipv6InterfaceTable_indexes_set(ipv6InterfaceTable_rowreq_ctx * rowreq_ctx,
                               long ipv6InterfaceIfIndex_val)
{
    DEBUGMSGTL(("verbose:ipv6InterfaceTable:ipv6InterfaceTable_indexes_set", "called\n"));

    if (MFD_SUCCESS !=
        ipv6InterfaceTable_indexes_set_tbl_idx(&rowreq_ctx->tbl_idx,
    ...
    if (0 != ipv6InterfaceTable_index_to_oid(&rowreq_ctx->oid_idx,
                                             &rowreq_ctx->tbl_idx)) {
        return MFD_ERROR;
    }

    return MFD_SUCCESS;
}                               /* ipv6InterfaceTable_indexes_set */
