...
{
    DEBUGMSGTL(("verbose:ipv4InterfaceTable:ipv4InterfaceTable_indexes_set_tbl_idx", "called\n"));

    /*
     * ipv4InterfaceIfIndex(1)/InterfaceIndex/ASN_INTEGER/long(long)//l/a/w/e/R/d/H 
     */
    tbl_idx->ipv4InterfaceIfIndex = ipv4InterfaceIfIndex_val;


    return MFD_SUCCESS;
}                               /* ipv4InterfaceTable_indexes_set_tbl_idx */
 ...
 */
int
ipv4InterfaceTable_indexes_set(ipv4InterfaceTable_rowreq_ctx * rowreq_ctx,
                               long ipv4InterfaceIfIndex_val)
{
    DEBUGMSGTL(("verbose:ipv4InterfaceTable:ipv4InterfaceTable_indexes_set", "called\n"));

    if (MFD_SUCCESS !=
        ipv4InterfaceTable_indexes_set_tbl_idx(&rowreq_ctx->tbl_idx,
    ...
    if (0 != ipv4InterfaceTable_index_to_oid(&rowreq_ctx->oid_idx,
                                             &rowreq_ctx->tbl_idx)) {
        return MFD_ERROR;
    }

    return MFD_SUCCESS;
}                               /* ipv4InterfaceTable_indexes_set */
