...
ipv4InterfaceTable_container_load(netsnmp_container * container)
{
    ...
    DEBUGMSGTL(("verbose:ipv4InterfaceTable:ipv4InterfaceTable_container_load", "called\n"));

    /*
     * TODO:351:M: |-> Load/update data in the ipv4InterfaceTable container.
     * loop over your ipv4InterfaceTable data, allocate a rowreq context,
    ...
    while (1) {
        ...
        /*
         * TODO:352:M: |   |-> set indexes in new ipv4InterfaceTable rowreq context.
         * data context will be set from the param (unless NULL,
         *      in which case a new data context will be allocated)
         */
        rowreq_ctx = ipv4InterfaceTable_allocate_rowreq_ctx(NULL);
        if (NULL == rowreq_ctx) {
            snmp_log(LOG_ERR, "memory allocation failed\n");
            return MFD_RESOURCE_UNAVAILABLE;
        }
        if (MFD_SUCCESS !=
            ipv4InterfaceTable_indexes_set(rowreq_ctx,
                                           ipv4InterfaceIfIndex)) {
            snmp_log(LOG_ERR,
                     "error setting index while loading "
                     "ipv4InterfaceTable data.\n");
            ipv4InterfaceTable_release_rowreq_ctx(rowreq_ctx);
            continue;
        }

        /*
         * TODO:352:r: |   |-> populate ipv4InterfaceTable data context.
    ...
    DEBUGMSGT(("verbose:ipv4InterfaceTable:ipv4InterfaceTable_container_load", "inserted %d records\n", count));
