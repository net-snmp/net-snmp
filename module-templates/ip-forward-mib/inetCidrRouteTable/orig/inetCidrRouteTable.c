                                   ...
                                   rowreq_ctx, void *user_init_ctx)
{
     ...
     */
    rowreq_ctx->data->inetCidrRouteNextHopAS = 0;

    rowreq_ctx->data->inetCidrRouteMetric1 = -1;

    rowreq_ctx->data->inetCidrRouteMetric2 = -1;

    rowreq_ctx->data->inetCidrRouteMetric3 = -1;

    rowreq_ctx->data->inetCidrRouteMetric4 = -1;

    rowreq_ctx->data->inetCidrRouteMetric5 = -1;
...
inetCidrRouteTable_allocate_data(void)
{
    ...
    inetCidrRouteTable_data *rtn =
        SNMP_MALLOC_TYPEDEF(inetCidrRouteTable_data);
                         ...
                         long *inetCidrRouteIfIndex_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteIfIndex not implemented: skipping\n");
    return MFD_SKIP;
                      ...
                      u_long * inetCidrRouteType_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteType not implemented: skipping\n");
    return MFD_SKIP;
                       ...
                       u_long * inetCidrRouteProto_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteProto not implemented: skipping\n");
    return MFD_SKIP;
                     ...
                     u_long * inetCidrRouteAge_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteAge not implemented: skipping\n");
    return MFD_SKIP;
                           ...
                           u_long * inetCidrRouteNextHopAS_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteNextHopAS not implemented: skipping\n");
    return MFD_SKIP;
                         ...
                         long *inetCidrRouteMetric1_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteMetric1 not implemented: skipping\n");
    return MFD_SKIP;
                         ...
                         long *inetCidrRouteMetric2_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteMetric2 not implemented: skipping\n");
    return MFD_SKIP;
                         ...
                         long *inetCidrRouteMetric3_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteMetric3 not implemented: skipping\n");
    return MFD_SKIP;
                         ...
                         long *inetCidrRouteMetric4_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteMetric4 not implemented: skipping\n");
    return MFD_SKIP;
                         ...
                         long *inetCidrRouteMetric5_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    snmp_log(LOG_ERR,
             "inetCidrRouteTable node inetCidrRouteMetric5 not implemented: skipping\n");
    return MFD_SKIP;
                        ...
                        u_long * inetCidrRouteStatus_val_ptr)
{
   /** we should have a non-NULL pointer */
    ...
    /** WARNING: this code might not work for netsnmp_route_entry */
    (*inetCidrRouteStatus_val_ptr) = rowreq_ctx->data->inetCidrRouteStatus;
...
inetCidrRouteTable_commit(inetCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
     ...
     */
    if (save_flags & COLUMN_INETCIDRROUTEIFINDEX_FLAG) {
        save_flags &= ~COLUMN_INETCIDRROUTEIFINDEX_FLAG;        /* clear inetCidrRouteIfIndex */
        /*
        ...
        if (-1 == rc) {
            ...
            rowreq_ctx->column_set_flags |=
                COLUMN_INETCIDRROUTEIFINDEX_FLAG;
        }
    }

    if (save_flags & COLUMN_INETCIDRROUTETYPE_FLAG) {
        save_flags &= ~COLUMN_INETCIDRROUTETYPE_FLAG;   /* clear inetCidrRouteType */
        /*
    ...
    if (save_flags & COLUMN_INETCIDRROUTENEXTHOPAS_FLAG) {
        save_flags &= ~COLUMN_INETCIDRROUTENEXTHOPAS_FLAG;      /* clear inetCidrRouteNextHopAS */
        /*
        ...
        if (-1 == rc) {
             ...
             */
            rowreq_ctx->column_set_flags |=
                COLUMN_INETCIDRROUTENEXTHOPAS_FLAG;
        }
    }

    if (save_flags & COLUMN_INETCIDRROUTEMETRIC1_FLAG) {
        save_flags &= ~COLUMN_INETCIDRROUTEMETRIC1_FLAG;        /* clear inetCidrRouteMetric1 */
        /*
        ...
        if (-1 == rc) {
             ...
             */
            rowreq_ctx->column_set_flags |=
                COLUMN_INETCIDRROUTEMETRIC1_FLAG;
        }
    }

    if (save_flags & COLUMN_INETCIDRROUTEMETRIC2_FLAG) {
        save_flags &= ~COLUMN_INETCIDRROUTEMETRIC2_FLAG;        /* clear inetCidrRouteMetric2 */
        /*
         * TODO:482:o: |-> commit column inetCidrRouteMetric2.
         */
        rc = -1;
        if (-1 == rc) {
            snmp_log(LOG_ERR,
                     "inetCidrRouteTable column inetCidrRouteMetric2 commit failed\n");
        } else {
            /*
             * set flag, in case we need to undo inetCidrRouteMetric2
             */
            rowreq_ctx->column_set_flags |=
                COLUMN_INETCIDRROUTEMETRIC2_FLAG;
        }
    }

    if (save_flags & COLUMN_INETCIDRROUTEMETRIC3_FLAG) {
        save_flags &= ~COLUMN_INETCIDRROUTEMETRIC3_FLAG;        /* clear inetCidrRouteMetric3 */
        /*
         * TODO:482:o: |-> commit column inetCidrRouteMetric3.
         */
        rc = -1;
        if (-1 == rc) {
            snmp_log(LOG_ERR,
                     "inetCidrRouteTable column inetCidrRouteMetric3 commit failed\n");
        } else {
            /*
             * set flag, in case we need to undo inetCidrRouteMetric3
             */
            rowreq_ctx->column_set_flags |=
    ...
    if (save_flags & COLUMN_INETCIDRROUTEMETRIC4_FLAG) {
        save_flags &= ~COLUMN_INETCIDRROUTEMETRIC4_FLAG;        /* clear inetCidrRouteMetric4 */
        /*
         * TODO:482:o: |-> commit column inetCidrRouteMetric4.
         */
        rc = -1;
        if (-1 == rc) {
            snmp_log(LOG_ERR,
                     "inetCidrRouteTable column inetCidrRouteMetric4 commit failed\n");
        } else {
            /*
             * set flag, in case we need to undo inetCidrRouteMetric4
             */
            rowreq_ctx->column_set_flags |=
                COLUMN_INETCIDRROUTEMETRIC4_FLAG;
        }
    }

    if (save_flags & COLUMN_INETCIDRROUTEMETRIC5_FLAG) {
        save_flags &= ~COLUMN_INETCIDRROUTEMETRIC5_FLAG;        /* clear inetCidrRouteMetric5 */
        /*
         * TODO:482:o: |-> commit column inetCidrRouteMetric5.
         */
        rc = -1;
        if (-1 == rc) {
            snmp_log(LOG_ERR,
                     "inetCidrRouteTable column inetCidrRouteMetric5 commit failed\n");
        } else {
            /*
             * set flag, in case we need to undo inetCidrRouteMetric5
             */
            rowreq_ctx->column_set_flags |=
                COLUMN_INETCIDRROUTEMETRIC5_FLAG;
        }
    }

    if (save_flags & COLUMN_INETCIDRROUTESTATUS_FLAG) {
        save_flags &= ~COLUMN_INETCIDRROUTESTATUS_FLAG; /* clear inetCidrRouteStatus */
        /*
                                 ...
                                 rowreq_ctx, long inetCidrRouteMetric2_val)
{
    ...
    return MFD_SUCCESS;         /* inetCidrRouteMetric2 value not illegal */
                                 ...
                                 rowreq_ctx, long inetCidrRouteMetric3_val)
{
    ...
    return MFD_SUCCESS;         /* inetCidrRouteMetric3 value not illegal */
                                 ...
                                 rowreq_ctx, long inetCidrRouteMetric4_val)
{
    ...
    return MFD_SUCCESS;         /* inetCidrRouteMetric4 value not illegal */
                                 ...
                                 rowreq_ctx, long inetCidrRouteMetric5_val)
{
    ...
    return MFD_SUCCESS;         /* inetCidrRouteMetric5 value not illegal */
                                      ...
                                      rowreq_ctx)
{
    ...
    if (rowreq_ctx->column_set_flags & COLUMN_INETCIDRROUTESTATUS_FLAG) {
        ...
        if (rowreq_ctx->rowreq_flags & MFD_ROW_CREATED) {
            if (ROWSTATUS_DESTROY == rowreq_ctx->data->inetCidrRouteStatus) {
                rowreq_ctx->rowreq_flags |= MFD_ROW_DELETED;
            } else if (ROWSTATUS_CREATEANDGO ==
                       rowreq_ctx->data->inetCidrRouteStatus) {
                if ((rowreq_ctx->
                ...
                rowreq_ctx->data->inetCidrRouteStatus = ROWSTATUS_ACTIVE;
            }
        } /* row creation */
        else {
            /*
