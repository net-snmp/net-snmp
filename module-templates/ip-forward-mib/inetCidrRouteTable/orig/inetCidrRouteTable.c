                         ...
                         long *inetCidrRouteIfIndex_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteIfIndex data */
                      ...
                      u_long * inetCidrRouteType_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteType data */
                       ...
                       u_long * inetCidrRouteProto_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteProto data */
                     ...
                     u_long * inetCidrRouteAge_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteAge data */
                           ...
                           u_long * inetCidrRouteNextHopAS_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteNextHopAS data */
                         ...
                         long *inetCidrRouteMetric1_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteMetric1 data */
                         ...
                         long *inetCidrRouteMetric2_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteMetric2 data */
                         ...
                         long *inetCidrRouteMetric3_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteMetric3 data */
                         ...
                         long *inetCidrRouteMetric4_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteMetric4 data */
                         ...
                         long *inetCidrRouteMetric5_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set inetCidrRouteMetric5 data */
...
inetCidrRouteTable_commit(inetCidrRouteTable_rowreq_ctx * rowreq_ctx)
{
    ...
    if (save_flags & FLAG_INETCIDRROUTEMETRIC2) {
        save_flags &= ~FLAG_INETCIDRROUTEMETRIC2;       /* clear inetCidrRouteMetric2 */
        /*
    ...
    if (save_flags & FLAG_INETCIDRROUTEMETRIC3) {
        save_flags &= ~FLAG_INETCIDRROUTEMETRIC3;       /* clear inetCidrRouteMetric3 */
        /*
    ...
    if (save_flags & FLAG_INETCIDRROUTEMETRIC4) {
        save_flags &= ~FLAG_INETCIDRROUTEMETRIC4;       /* clear inetCidrRouteMetric4 */
        /*
    ...
    if (save_flags & FLAG_INETCIDRROUTEMETRIC5) {
        save_flags &= ~FLAG_INETCIDRROUTEMETRIC5;       /* clear inetCidrRouteMetric5 */
        /*
