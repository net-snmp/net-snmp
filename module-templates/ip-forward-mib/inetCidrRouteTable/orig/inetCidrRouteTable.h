...
#include <net-snmp/library/asn1.h>
     ...
     */
    /* *INDENT-OFF*  */
config_require(inetCidrRouteTable_interface);
config_require(inetCidrRouteTable_data_access);
    /* *INDENT-ON*  */
