 ...
 */
static int
_mfd_inetCidrRouteTable_check_dependencies(netsnmp_mib_handler *handler,
                                           netsnmp_handler_registration
                                           *reginfo,
                                           netsnmp_agent_request_info
                                           *agtreq_info,
                                ...
                                netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:inetCidrRouteTable:_inetCidrRouteTable_undo_column", "called for %d\n", column));
 ...
 */
int
_mfd_inetCidrRouteTable_irreversible_commit(netsnmp_mib_handler *handler,
                                            netsnmp_handler_registration
                                            *reginfo,
                                            netsnmp_agent_request_info
                                            *agtreq_info,
