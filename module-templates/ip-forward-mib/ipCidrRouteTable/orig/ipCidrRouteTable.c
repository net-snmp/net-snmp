                       ...
                       long *ipCidrRouteIfIndex_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteIfIndex data */
                    ...
                    u_long * ipCidrRouteType_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteType data */
                     ...
                     u_long * ipCidrRouteProto_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteProto data */
                    ...
                    size_t *ipCidrRouteInfo_val_ptr_len_ptr)
{
   /** we should have a non-NULL pointer and enough storage */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteInfo data */
                         ...
                         long *ipCidrRouteNextHopAS_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteNextHopAS data */
                       ...
                       long *ipCidrRouteMetric1_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteMetric1 data */
                       ...
                       long *ipCidrRouteMetric2_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteMetric2 data */
                       ...
                       long *ipCidrRouteMetric3_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteMetric3 data */
                       ...
                       long *ipCidrRouteMetric4_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteMetric4 data */
                       ...
                       long *ipCidrRouteMetric5_val_ptr)
{
   /** we should have a non-NULL pointer */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set ipCidrRouteMetric5 data */
