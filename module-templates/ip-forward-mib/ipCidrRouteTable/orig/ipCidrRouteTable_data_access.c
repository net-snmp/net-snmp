...
ipCidrRouteTable_container_load(netsnmp_container * container)
{
    ...
    DEBUGMSGTL(("verbose:ipCidrRouteTable:ipCidrRouteTable_container_load",
                "called\n"));
    ...
    while (1) {
        ...
        /*
         * TODO:352:M: |   |-> set indexes in new ipCidrRouteTable rowreq context.
         ...
         *      ipCidrRouteTablerowreq_ctx_init.
         */
        ...
        if (MFD_SUCCESS !=
            ipCidrRouteTable_indexes_set(rowreq_ctx, ipCidrRouteDest,
                                         ipCidrRouteMask, ipCidrRouteTos,
                                         ipCidrRouteNextHop)) {
            snmp_log(LOG_ERR,
                     "error setting index while loading "
                     "ipCidrRouteTable data.\n");
            ipCidrRouteTable_release_rowreq_ctx(rowreq_ctx);
            continue;
        }

        /*
         * TODO:352:r: |   |-> populate ipCidrRouteTable data context.
    ...
    DEBUGMSGT(("verbose:ipCidrRouteTable:ipCidrRouteTable_container_load",
               "inserted %d records\n", count));
