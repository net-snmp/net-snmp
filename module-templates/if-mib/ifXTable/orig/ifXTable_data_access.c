 ...
 * load cache data
 *
 * TODO:350:M: Implement ifXTable cache load
 *
...
ifXTable_cache_load(netsnmp_container * container)
{
    ...
    DEBUGMSGTL(("verbose:ifXTable:ifXTable_cache_load", "called\n"));
    ...
    DEBUGMSGT(("verbose:ifXTable:ifXTable_cache_load",
               "inserted %d records\n", count));
...
{
    DEBUGMSGTL(("verbose:ifXTable:ifXTable_cache_free", "called\n"));

    /*
     * TODO:380:M: Free ifXTable cache.
     */
}                               /* ifXTable_cache_free */
