...
NETSNMP_STATIC_INLINE int _ifXTable_check_indexes(ifXTable_rowreq_ctx *
                                                  rowreq_ctx);
...
ifXTable_allocate_rowreq_ctx(void *user_init_ctx)
{
    ...
    DEBUGMSGTL(("internal:ifXTable:ifXTable_allocate_rowreq_ctx",
                "called\n"));
...
{
    DEBUGMSGTL(("internal:ifXTable:ifXTable_release_rowreq_ctx",
                "called\n"));
...
NETSNMP_STATIC_INLINE int
_ifXTable_check_indexes(ifXTable_rowreq_ctx * rowreq_ctx)
{
    int             rc = SNMPERR_SUCCESS;

    DEBUGMSGTL(("internal:ifXTable:_ifXTable_check_indexes", "called\n"));
     ...
     */
    rc = ifXTable_ifIndex_check_index(rowreq_ctx);
    if (MFD_SUCCESS != rc)
     ...
     */
    return ifXTable_validate_index(ifXTable_if_ctx.user_ctx, rowreq_ctx);
}                               /* _ifXTable_check_indexes */
 ...
 */
static void
_container_item_free(ifXTable_rowreq_ctx * rowreq_ctx, void *context)
{
...
_container_free(netsnmp_container * container)
{
    ...
    if (NULL == container) {
        snmp_log(LOG_ERR,
                 "invalid container in ifXTable_container_free\n");
        return;
    }
...
_ifXTable_container_row_restore(const char *token, char *buf)
{
    ifXTable_rowreq_ctx *rowreq_ctx;
    netsnmp_index   index;
    oid             tmp_oid[MAX_ifXTable_IDX_LEN];
    u_int           col = 0, found = 0;
    ...
    rowreq_ctx = _mfd_ifXTable_rowreq_from_index(&index, NULL);
    if (NULL == rowreq_ctx) {
                             ...
                             u_int col, char *buf)
{
    ...
    case COLUMN_IFNAME:    /** DisplayString = ASN_OCTET_STR */
        buf = read_config_save_octet_string(buf, rowreq_ctx->data.ifName,
                                            rowreq_ctx->data.ifName_len);
        break;

    case COLUMN_IFINMULTICASTPKTS:    /** COUNTER = ASN_COUNTER */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifInMulticastPkts);
        break;

    case COLUMN_IFINBROADCASTPKTS:    /** COUNTER = ASN_COUNTER */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifInBroadcastPkts);
        break;

    case COLUMN_IFOUTMULTICASTPKTS:    /** COUNTER = ASN_COUNTER */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifOutMulticastPkts);
        break;

    case COLUMN_IFOUTBROADCASTPKTS:    /** COUNTER = ASN_COUNTER */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifOutBroadcastPkts);
        break;

    case COLUMN_IFHCINOCTETS:    /** COUNTER64 = ASN_COUNTER64 */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifHCInOctets);
        break;

    case COLUMN_IFHCINUCASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifHCInUcastPkts);
        break;

    case COLUMN_IFHCINMULTICASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifHCInMulticastPkts);
        break;

    case COLUMN_IFHCINBROADCASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifHCInBroadcastPkts);
        break;

    case COLUMN_IFHCOUTOCTETS:    /** COUNTER64 = ASN_COUNTER64 */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifHCOutOctets);
        break;

    case COLUMN_IFHCOUTUCASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifHCOutUcastPkts);
        break;

    case COLUMN_IFHCOUTMULTICASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifHCOutMulticastPkts);
        break;

    case COLUMN_IFHCOUTBROADCASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifHCOutBroadcastPkts);
        break;
    ...
    case COLUMN_IFHIGHSPEED:    /** GAUGE = ASN_GAUGE */
        buf += sprintf(buf, "%lu", rowreq_ctx->data.ifHighSpeed);
        break;
    ...
    case COLUMN_IFCONNECTORPRESENT:    /** TruthValue = ASN_INTEGER */
        buf += sprintf(buf, "%ld", rowreq_ctx->data.ifConnectorPresent);
        break;
    ...
    case COLUMN_IFCOUNTERDISCONTINUITYTIME:    /** TimeStamp = ASN_TIMETICKS */
        buf +=
            sprintf(buf, "%lu",
                                ...
                                u_int col, char *buf)
{
    ...
    case COLUMN_IFNAME:    /** DisplayString = ASN_OCTET_STR */
        rowreq_ctx->data.ifName_len = sizeof(rowreq_ctx->data.ifName);
        buf = read_config_read_memory(ASN_OCTET_STR, buf,
                                      (char *) &rowreq_ctx->data.ifName,
                                      (size_t *) &rowreq_ctx->data.
                                      ifName_len);
        break;

    case COLUMN_IFINMULTICASTPKTS:    /** COUNTER = ASN_COUNTER */
        len = sizeof(rowreq_ctx->data.ifInMulticastPkts);
        buf = read_config_read_memory(ASN_COUNTER, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifInMulticastPkts, &len);
        break;

    case COLUMN_IFINBROADCASTPKTS:    /** COUNTER = ASN_COUNTER */
        len = sizeof(rowreq_ctx->data.ifInBroadcastPkts);
        buf = read_config_read_memory(ASN_COUNTER, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifInBroadcastPkts, &len);
        break;

    case COLUMN_IFOUTMULTICASTPKTS:    /** COUNTER = ASN_COUNTER */
        len = sizeof(rowreq_ctx->data.ifOutMulticastPkts);
        buf = read_config_read_memory(ASN_COUNTER, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifOutMulticastPkts, &len);
        break;

    case COLUMN_IFOUTBROADCASTPKTS:    /** COUNTER = ASN_COUNTER */
        len = sizeof(rowreq_ctx->data.ifOutBroadcastPkts);
        buf = read_config_read_memory(ASN_COUNTER, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifOutBroadcastPkts, &len);
        break;

    case COLUMN_IFHCINOCTETS:    /** COUNTER64 = ASN_COUNTER64 */
        len = sizeof(rowreq_ctx->data.ifHCInOctets);
    ...
    case COLUMN_IFHCINUCASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        len = sizeof(rowreq_ctx->data.ifHCInUcastPkts);
        buf = read_config_read_memory(ASN_COUNTER64, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifHCInUcastPkts, &len);
        break;
    ...
    case COLUMN_IFHCINMULTICASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        len = sizeof(rowreq_ctx->data.ifHCInMulticastPkts);
        buf = read_config_read_memory(ASN_COUNTER64, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifHCInMulticastPkts, &len);
        break;

    case COLUMN_IFHCINBROADCASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        len = sizeof(rowreq_ctx->data.ifHCInBroadcastPkts);
        buf = read_config_read_memory(ASN_COUNTER64, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifHCInBroadcastPkts, &len);
        break;

    case COLUMN_IFHCOUTOCTETS:    /** COUNTER64 = ASN_COUNTER64 */
        len = sizeof(rowreq_ctx->data.ifHCOutOctets);
        buf = read_config_read_memory(ASN_COUNTER64, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifHCOutOctets, &len);
        break;
    ...
    case COLUMN_IFHCOUTUCASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        len = sizeof(rowreq_ctx->data.ifHCOutUcastPkts);
        buf = read_config_read_memory(ASN_COUNTER64, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifHCOutUcastPkts, &len);
        break;

    case COLUMN_IFHCOUTMULTICASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        len = sizeof(rowreq_ctx->data.ifHCOutMulticastPkts);
        buf = read_config_read_memory(ASN_COUNTER64, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifHCOutMulticastPkts, &len);
        break;

    case COLUMN_IFHCOUTBROADCASTPKTS:    /** COUNTER64 = ASN_COUNTER64 */
        len = sizeof(rowreq_ctx->data.ifHCOutBroadcastPkts);
        buf = read_config_read_memory(ASN_COUNTER64, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifHCOutBroadcastPkts, &len);
        break;
    ...
    case COLUMN_IFHIGHSPEED:    /** GAUGE = ASN_GAUGE */
        len = sizeof(rowreq_ctx->data.ifHighSpeed);
    ...
    case COLUMN_IFCONNECTORPRESENT:    /** TruthValue = ASN_INTEGER */
        len = sizeof(rowreq_ctx->data.ifConnectorPresent);
        buf = read_config_read_memory(ASN_INTEGER, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifConnectorPresent, &len);
        break;
    ...
    case COLUMN_IFCOUNTERDISCONTINUITYTIME:    /** TimeStamp = ASN_TIMETICKS */
        len = sizeof(rowreq_ctx->data.ifCounterDiscontinuityTime);
        buf = read_config_read_memory(ASN_TIMETICKS, buf,
                                      (char *) &rowreq_ctx->data.
                                      ifCounterDiscontinuityTime, &len);
        break;
