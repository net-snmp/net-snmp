...
udpEndpointTable_container_load(netsnmp_container * container)
{
     ...
     */
        /** 128 - 1(entry) - 1(col) - 6(other indexes) = 110 */
    char            udpEndpointLocalAddress[110];
     ...
     */
        /** 128 - 1(entry) - 1(col) - 6(other indexes) = 110 */
    char            udpEndpointRemoteAddress[110];
    ...
    while (1) {
        ...
        if (MFD_SUCCESS !=
            udpEndpointTable_indexes_set(rowreq_ctx,
                                         ...
                                         udpEndpointLocalAddress_len,
                                         udpEndpointLocalPort,
                                         udpEndpointRemoteAddressType,
                                         udpEndpointRemoteAddress,
                                         udpEndpointRemoteAddress_len,
