 ...
 *       version : 1.32.2.1 $ of : mfd-top.m2c,v $
 *
 * $Id$
 */
...
#include <net-snmp/library/asn1.h>
     ...
     */
    /* *INDENT-OFF*  */
config_require(usmDHUserKeyTable_interface);
config_require(usmDHUserKeyTable_data_access);
config_require(usmDHUserKeyTable_data_get);
config_require(usmDHUserKeyTable_data_set);
    /* *INDENT-ON*  */
