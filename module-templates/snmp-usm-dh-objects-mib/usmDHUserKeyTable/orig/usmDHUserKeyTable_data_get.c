                           ...
                           size_t *usmDHUserAuthKeyChange_val_ptr_len_ptr)
{
   /** we should have a non-NULL pointer and enough storage */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set usmDHUserAuthKeyChange data */
                              ...
                              *usmDHUserOwnAuthKeyChange_val_ptr_len_ptr)
{
   /** we should have a non-NULL pointer and enough storage */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set usmDHUserOwnAuthKeyChange data */
                           ...
                           size_t *usmDHUserPrivKeyChange_val_ptr_len_ptr)
{
   /** we should have a non-NULL pointer and enough storage */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set usmDHUserPrivKeyChange data */
                              ...
                              *usmDHUserOwnPrivKeyChange_val_ptr_len_ptr)
{
   /** we should have a non-NULL pointer and enough storage */
     ...
     */
    return MFD_SKIP;            /* TODO:235:M: |-> Remove SKIP once you've set usmDHUserOwnPrivKeyChange data */
