...
usmDHUserKeyTable_commit(usmDHUserKeyTable_rowreq_ctx * rowreq_ctx)
{
     ...
     */
    if (save_flags & COLUMN_USMDHUSERAUTHKEYCHANGE_FLAG) {
        save_flags &= ~COLUMN_USMDHUSERAUTHKEYCHANGE_FLAG;      /* clear usmDHUserAuthKeyChange */
        /*
        ...
        if (-1 == rc) {
            ...
            rowreq_ctx->column_set_flags |=
                COLUMN_USMDHUSERAUTHKEYCHANGE_FLAG;
        }
    }

    if (save_flags & COLUMN_USMDHUSEROWNAUTHKEYCHANGE_FLAG) {
        save_flags &= ~COLUMN_USMDHUSEROWNAUTHKEYCHANGE_FLAG;   /* clear usmDHUserOwnAuthKeyChange */
        /*
    ...
    if (save_flags & COLUMN_USMDHUSERPRIVKEYCHANGE_FLAG) {
        save_flags &= ~COLUMN_USMDHUSERPRIVKEYCHANGE_FLAG;      /* clear usmDHUserPrivKeyChange */
        /*
        ...
        if (-1 == rc) {
             ...
             */
            rowreq_ctx->column_set_flags |=
                COLUMN_USMDHUSERPRIVKEYCHANGE_FLAG;
        }
    }

    if (save_flags & COLUMN_USMDHUSEROWNPRIVKEYCHANGE_FLAG) {
        save_flags &= ~COLUMN_USMDHUSEROWNPRIVKEYCHANGE_FLAG;   /* clear usmDHUserOwnPrivKeyChange */
        /*
