...
BEGIN {
    ...
    %tests = ( 
                  ...
                  "NETSNMP_DS_LIB_DISABLE_V1"              => 43,
                  "NETSNMP_DS_LIB_DISABLE_V2c"             => 44,
                  "NETSNMP_DS_LIB_DISABLE_V3"              => 45,
                  "NETSNMP_DS_LIB_FILTER_SOURCE"           => 46,
                  "NETSNMP_DS_LIB_ADD_FORWARDER_INFO"      => 47,
                  "NETSNMP_DS_LIB_SSH_AGENT"               => 48,
                  "NETSNMP_DS_LIB_MAX_BOOL_ID"             => 64,
                  ...
                  "NETSNMP_DS_LIB_MSG_SEND_MAX"            => 16,
                  "NETSNMP_DS_LIB_FILTER_TYPE"             => 17,
                  "NETSNMP_DS_LIB_MAX_INT_ID"              => 64,
                  ...
                  "NETSNMP_DS_LIB_OUTPUT_PRECISION"        => 35,
                  "NETSNMP_DS_LIB_TLS_MIN_VERSION"         => 36,
                  "NETSNMP_DS_LIB_TLS_MAX_VERSION"         => 37,
                  "NETSNMP_DS_LIB_MAX_STR_ID"              => 64,
	);
