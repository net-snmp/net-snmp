...
void context_destroyEntry __UCD_P((oid *,int));

struct contextEntry *
context_getEntry __UCD_P((oid *contextID, int contextIDLen));
/*
...
struct contextEntry *
context_createEntry __UCD_P((oid *contextID, int contextIDLen));
/*
...
int read_context_database __UCD_P((char *));
