...
# ADD LINK32 netsnmp.lib advapi32.lib wsock32.lib msvcrt.lib kernel32.lib user32.lib oldnames.lib /nologo /subsystem:console /machine:I386 /nodefaultlib /out:"../bin/snmpgetnext.exe" /libpath:"..\lib"
...
# ADD LINK32 advapi32.lib netsnmp_d.lib wsock32.lib libcmt.lib kernel32.lib user32.lib oldnames.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib /out:"../bin/snmpgetnext_d.exe" /pdbtype:sept /libpath:"../lib"
