...
struct variable4 {
    ...
    u_char          *(*findVar) (struct variable *, oid *, int *, int, int *,
				 int(**write_proc) (int, u_char *, u_char, int, u_char *, oid *, int));  /* function that finds variable */
    u_char          namelen;        /* length of name below */
...
struct variable7 {
    ...
    char            type;           /* type of variable */
    u_short         acl;            /* access control list for variable */
    u_char          *(*findVar)(struct variable *, oid *, int *, int, int *, int(**write)(int, u_char *, u_char, int, u_char *, oid *, int));  /* function that finds variable */
    u_char          namelen;        /* length of name below */
