...
static ipSystemStatsTable_data *ipSystemStatsTable_allocate_data(void);
    ...
    (ipSystemStatsTable_registration_ptr reg_ptr, u_long flags)
{
    ...
    DEBUGMSGTL(("internal:_ipSystemStatsTable_initialize_interface",
                "called\n"));
    ...
    reginfo =
        netsnmp_handler_registration_create("ipSystemStatsTable", handler,
                                            ...
                                            HANDLER_CAN_RONLY);
    if (NULL == reginfo) {
        snmp_log(LOG_ERR, "error registering tabel ipSystemStatsTable\n");
        return;
    }
                                ...
                                ipSystemStatsTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:ipSystemStatsTable_index_to_oid", "called\n"));
                                  ...
                                  ipSystemStatsTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:ipSystemStatsTable_index_from_oid", "called\n"));
...
ipSystemStatsTable_allocate_rowreq_ctx(ipSystemStatsTable_data * data)
{
    ...
    DEBUGMSGTL(("internal:ipSystemStatsTable_allocate_rowreq_ctx",
                "called\n"));
...
ipSystemStatsTable_release_rowreq_ctx(ipSystemStatsTable_rowreq_ctx *
                                      rowreq_ctx)
{
    DEBUGMSGTL(("internal:ipSystemStatsTable_release_rowreq_ctx",
                "called\n"));
...
{
    return ipSystemStatsTable_pre_request(ipSystemStatsTable_if_ctx.
                                          user_ctx);
}
...
_mfd_ipSystemStatsTable_post_request(netsnmp_mib_handler *handler,
                                     ...
                                     *agtreq_info,
                                     netsnmp_request_info *requests)
{
    return ipSystemStatsTable_post_request(ipSystemStatsTable_if_ctx.
                                           user_ctx);
}
 ...
 */
static int
_mfd_ipSystemStatsTable_object_lookup(netsnmp_mib_handler *handler,
                                      ...
                                      netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ipSystemStatsTable_object_lookup",
                "called\n"));
                               ...
                               netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_ipSystemStatsTable_get_column", "called\n"));
                                   ...
                                   netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_ipSystemStatsTable_get_values",
                "called\n"));
