...
struct variable4 hrdisk_variables[] = {
    { HRDISK_ACCESS,    INTEGER, RONLY, var_hrdisk, 2, {1,1}},
    { HRDISK_MEDIA,     INTEGER, RONLY, var_hrdisk, 2, {1,2}},
    { HRDISK_REMOVEABLE,INTEGER, RONLY, var_hrdisk, 2, {1,3}},
    { HRDISK_CAPACITY,  INTEGER, RONLY, var_hrdisk, 2, {1,4}}
};
