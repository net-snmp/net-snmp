...
oid mteTriggerBooleanTable_variables_oid[] = { 1,3,6,1,2,1,88,1,2,5 };
...
#define   MTETRIGGERBOOLEANCOMPARISON  3
  { MTETRIGGERBOOLEANCOMPARISON, ASN_INTEGER   , RWRITE, var_mteTriggerBooleanTable, 2, { 1,1 } },
#define   MTETRIGGERBOOLEANVALUE  4
  { MTETRIGGERBOOLEANVALUE, ASN_INTEGER   , RWRITE, var_mteTriggerBooleanTable, 2, { 1,2 } },
#define   MTETRIGGERBOOLEANSTARTUP  5
  { MTETRIGGERBOOLEANSTARTUP, ASN_INTEGER   , RWRITE, var_mteTriggerBooleanTable, 2, { 1,3 } },
#define   MTETRIGGERBOOLEANOBJECTSOWNER  6
  { MTETRIGGERBOOLEANOBJECTSOWNER, ASN_OCTET_STR , RWRITE, var_mteTriggerBooleanTable, 2, { 1,4 } },
#define   MTETRIGGERBOOLEANOBJECTS  7
  { MTETRIGGERBOOLEANOBJECTS, ASN_OCTET_STR , RWRITE, var_mteTriggerBooleanTable, 2, { 1,5 } },
#define   MTETRIGGERBOOLEANEVENTOWNER  8
  { MTETRIGGERBOOLEANEVENTOWNER, ASN_OCTET_STR , RWRITE, var_mteTriggerBooleanTable, 2, { 1,6 } },
#define   MTETRIGGERBOOLEANEVENT  9
  { MTETRIGGERBOOLEANEVENT, ASN_OCTET_STR , RWRITE, var_mteTriggerBooleanTable, 2, { 1,7 } },
...
void init_mteTriggerBooleanTable(void) {
  ...
  REGISTER_MIB("mteTriggerBooleanTable", mteTriggerBooleanTable_variables, variable2,
               mteTriggerBooleanTable_variables_oid);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerBooleanTable", "write_mteTriggerBooleanComparison entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerBooleanTable_variables_oid)/sizeof(oid) + 3 - 1], 
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerBooleanTable", "write_mteTriggerBooleanValue entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerBooleanTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerBooleanTable", "write_mteTriggerBooleanStartup entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerBooleanTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerBooleanTable", "write_mteTriggerBooleanObjectsOwner entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerBooleanTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerBooleanObjectsOwner, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerBooleanTable", "write_mteTriggerBooleanObjects entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerBooleanTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerBooleanObjects, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  DEBUGMSGTL(("mteTriggerBooleanTable", "write_mteTriggerBooleanEventOwner entering action=%d...  \n", action));
  if ((StorageTmp =
       header_complex(mteTriggerTableStorage, NULL,
                      &name[sizeof(mteTriggerBooleanTable_variables_oid)/sizeof(oid) + 3 - 1], 
                      &newlen, 1, NULL, NULL)) == NULL)
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerBooleanEventOwner, var_val, var_val_len);
            ...
            size_t    name_len)
{
  ...
  switch ( action ) {
        ...
        case ACTION:
             ...
             memdup((u_char **) &StorageTmp->mteTriggerBooleanEvent, var_val, var_val_len);
