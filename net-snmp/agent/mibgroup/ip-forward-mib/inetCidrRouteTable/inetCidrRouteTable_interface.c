...
static inetCidrRouteTable_data *inetCidrRouteTable_allocate_data(void);
    ...
    (inetCidrRouteTable_registration_ptr reg_ptr, u_long flags)
{
    ...
    DEBUGMSGTL(("internal:_inetCidrRouteTable_initialize_interface",
                "called\n"));
                                ...
                                inetCidrRouteTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:inetCidrRouteTable_index_to_oid", "called\n"));
                                  ...
                                  inetCidrRouteTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:inetCidrRouteTable_index_from_oid", "called\n"));
...
inetCidrRouteTable_allocate_rowreq_ctx(inetCidrRouteTable_data * data)
{
    ...
    DEBUGMSGTL(("internal:inetCidrRouteTable_allocate_rowreq_ctx",
                "called\n"));
...
inetCidrRouteTable_release_rowreq_ctx(inetCidrRouteTable_rowreq_ctx *
                                      rowreq_ctx)
{
    DEBUGMSGTL(("internal:inetCidrRouteTable_release_rowreq_ctx",
                "called\n"));
                                      ...
                                      netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetCidrRouteTable_object_lookup",
                "called\n"));
                               ...
                               netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_inetCidrRouteTable_get_column", "called\n"));
                                   ...
                                   netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetCidrRouteTable_get_values",
                "called\n"));
                                 ...
                                 int column)
{
    ...
    DEBUGMSGTL(("internal:_inetCidrRouteTable_check_column", "called\n"));
                                      ...
                                      netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetCidrRouteTable_check_objects",
                "called\n"));
                                  ...
                                  rowreq_ctx)
{
    ...
    DEBUGMSGTL(("internal:_inetCidrRouteTable_check_indexes", "called\n"));
                               ...
                               netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_inetCidrRouteTable_set_column", "called\n"));
                                   ...
                                   netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetCidrRouteTable_set_values",
                "called\n"));
                                    ...
                                    netsnmp_request_info *requests)
{
    inetCidrRouteTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    netsnmp_assert(NULL != rowreq_ctx);
    return inetCidrRouteTable_undo_commit(rowreq_ctx);
}
                                ...
                                netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_inetCidrRouteTable_undo_column", "called\n"));
                                    ...
                                    netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_inetCidrRouteTable_undo_values",
                "called\n"));
