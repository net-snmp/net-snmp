                                        ...
                                        reg_ptr, u_long flags)
{
    ...
    DEBUGMSGTL(("internal:_usmDHUserKeyTable_initialize_interface",
                "called\n"));
    ...
    reginfo =
        netsnmp_handler_registration_create("usmDHUserKeyTable", handler,
                                            ...
                                            HANDLER_CAN_RWRITE);
    if (NULL == reginfo) {
        snmp_log(LOG_ERR, "error registering tabel usmDHUserKeyTable\n");
        return;
    }
                               ...
                               usmDHUserKeyTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:usmDHUserKeyTable_index_to_oid", "called\n"));
                                 ...
                                 usmDHUserKeyTable_mib_index * mib_idx)
{
    ...
    DEBUGMSGTL(("verbose:usmDHUserKeyTable_index_from_oid", "called\n"));
...
usmDHUserKeyTable_allocate_rowreq_ctx(void)
{
    ...
    DEBUGMSGTL(("internal:usmDHUserKeyTable_allocate_rowreq_ctx",
                "called\n"));
...
usmDHUserKeyTable_release_rowreq_ctx(usmDHUserKeyTable_rowreq_ctx *
                                     rowreq_ctx)
{
    DEBUGMSGTL(("internal:usmDHUserKeyTable_release_rowreq_ctx",
                "called\n"));
...
{
    return usmDHUserKeyTable_pre_request(usmDHUserKeyTable_if_ctx.
                                         user_ctx);
}
...
_mfd_usmDHUserKeyTable_post_request(netsnmp_mib_handler *handler,
                                    ...
                                    *agtreq_info,
                                    netsnmp_request_info *requests)
{
    return usmDHUserKeyTable_post_request(usmDHUserKeyTable_if_ctx.
                                          user_ctx);
}
                                     ...
                                     netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_usmDHUserKeyTable_object_lookup",
                "called\n"));
                              ...
                              netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_usmDHUserKeyTable_get_column", "called\n"));
                                  ...
                                  netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_usmDHUserKeyTable_get_values", "called\n"));
                                ...
                                netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_usmDHUserKeyTable_check_column", "called\n"));
    ...
    default:    /** We shouldn't get here */
        rc = SNMP_ERR_GENERR;
        snmp_log(LOG_ERR,
                 "unknown column in _usmDHUserKeyTable_check_column\n");
    }
                                     ...
                                     netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_usmDHUserKeyTable_check_objects",
                "called\n"));
                                          ...
                                          netsnmp_request_info *requests)
{
    usmDHUserKeyTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    DEBUGMSGTL(("internal:_mfd_usmDHUserKeyTable_check_dependencies",
                "called\n"));

    netsnmp_assert(NULL != rowreq_ctx);

    return usmDHUserKeyTable_check_dependencies(rowreq_ctx);
}
                                  ...
                                  netsnmp_request_info *requests)
{
    ...
    return usmDHUserKeyTable_undo_setup(rowreq_ctx);
}
                                    ...
                                    netsnmp_request_info *requests)
{
     ...
     */
    if (rowreq_ctx->undo) {
        /* XXXWWW: this is called in 2 places...  but pointer not NULLed */
        usmDHUserKeyTable_release_data(rowreq_ctx->undo);
        rowreq_ctx->undo = NULL;
    }
                              ...
                              netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_usmDHUserKeyTable_set_column", "called\n"));
                                  ...
                                  netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_usmDHUserKeyTable_set_values", "called\n"));
                              ...
                              netsnmp_request_info *requests)
{
    usmDHUserKeyTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    netsnmp_assert(NULL != rowreq_ctx);
    return usmDHUserKeyTable_commit(rowreq_ctx);
}
                                   ...
                                   netsnmp_request_info *requests)
{
    usmDHUserKeyTable_rowreq_ctx *rowreq_ctx =
        netsnmp_container_table_extract_context(requests);
    netsnmp_assert(NULL != rowreq_ctx);
    return usmDHUserKeyTable_undo_commit(rowreq_ctx);
}
                               ...
                               netsnmp_variable_list * var, int column)
{
    ...
    DEBUGMSGTL(("internal:_usmDHUserKeyTable_undo_column", "called\n"));
                                   ...
                                   netsnmp_request_info *requests)
{
    ...
    DEBUGMSGTL(("internal:_mfd_usmDHUserKeyTable_undo_values",
                "called\n"));
    ...
    for (; requests; requests = requests->next) {
        ...
        _usmDHUserKeyTable_undo_column(rowreq_ctx, requests->requestvb,
                                       tri->colnum);
