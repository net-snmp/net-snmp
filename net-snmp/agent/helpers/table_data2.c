...
/** @defgroup tdata tdata: Helps you implement a table with datamatted storage.
 *  @ingroup table
 *
 ...
 */
int
netsnmp_tdata_helper_handler(netsnmp_mib_handler *handler,
