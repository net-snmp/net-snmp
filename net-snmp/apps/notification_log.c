...
initialize_table_nlmLogVariableTable(void)
{
     ...
     */
    table_set = netsnmp_create_netsnmp_table_data_set("nlmLogVariableTable");
    ...
    netsnmp_table_set_add_default_row(table_set, COLUMN_NLMLOGVARIABLECOUNTER32VAL,
                              ASN_COUNTER, 0);
    /*
    ...
    netsnmp_table_set_add_default_row(table_set, COLUMN_NLMLOGVARIABLETIMETICKSVAL,
                              ASN_TIMETICKS, 0);
    /*
    ...
    netsnmp_table_set_add_default_row(table_set, COLUMN_NLMLOGVARIABLEINTEGER32VAL,
                              ASN_INTEGER, 0);
    /*
    ...
    netsnmp_table_set_add_default_row(table_set, COLUMN_NLMLOGVARIABLEIPADDRESSVAL,
                              ASN_IPADDRESS, 0);
    /*
    ...
    netsnmp_table_set_add_default_row(table_set, COLUMN_NLMLOGVARIABLECOUNTER64VAL,
                              ASN_COUNTER64, 0);
    /*
...
initialize_table_nlmLogTable(void)
{
     ...
     * create the table structure itself 
     */
    nlmLogTable = netsnmp_create_netsnmp_table_data_set("nlmLogTable");
    ...
    netsnmp_table_set_add_default_row(nlmLogTable, COLUMN_NLMLOGTIME, ASN_TIMETICKS,
                              0);
    /*
...
init_notification_log(void) 
{
    ...
    /* static variables */
    netsnmp_register_read_only_counter32_instance("nlmStatsGlobalNotificationsLogged",
                                          my_nlmStatsGlobalNotificationsLogged_oid,
                                          OID_LENGTH(my_nlmStatsGlobalNotificationsLogged_oid),
                                          &num_received, NULL);

    netsnmp_register_read_only_counter32_instance("nlmStatsGlobalNotificationsBumped",
                 ...
                 netsnmp_transport *transport) 
{
    ...
    if (transport &&
        ...
        if (addr) {
            ...
            netsnmp_set_row_column(row, COLUMN_NLMLOGENGINETADDRESS, ASN_OCTET_STR,
    ...
    for(vptr = pdu->variables; vptr; vptr = vptr->next_variable) {
        if (snmp_oid_compare(snmptrapoid, snmptrapoid_len,
            ...
            netsnmp_set_row_column(row, COLUMN_NLMLOGNOTIFICATIONID, ASN_OBJECT_ID,
            ...
            /* OID */
            netsnmp_set_row_column(myrow, COLUMN_NLMLOGVARIABLEID, ASN_OBJECT_ID,
                           (u_char *) vptr->name,
            ...
            netsnmp_set_row_column(myrow, COLUMN_NLMLOGVARIABLEVALUETYPE, ASN_INTEGER,
