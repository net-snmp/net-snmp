...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "." /I ".." /I "..\..\snmplib" /I "..\.." /I "..\..\include" /I "..\..\agent" /I "..\..\agent\mibgroup" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "_NO_NETSNMP_DLL" /D "HAVE_WIN32_PLATFORM_SDK" /YX /FD /c
...
# ADD LINK32 netsnmpagent.lib netsnmpmibssdk.lib netsnmphelpers.lib netsnmp.lib advapi32.lib ws2_32.lib kernel32.lib user32.lib iphlpapi.lib /nologo /subsystem:console /pdb:none /machine:I386 /out:"../bin/snmpd.exe" /libpath:"../lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /I "." /I ".." /I "..\..\snmplib" /I "..\.." /I "..\..\include" /I "..\..\agent" /I "..\..\agent\mibgroup" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "_NO_NETSNMP_DLL" /D "HAVE_WIN32_PLATFORM_SDK" /FR /YX /FD /c
...
# ADD LINK32 netsnmpagent_d.lib netsnmpmibssdk_d.lib netsnmphelpers_d.lib netsnmp_d.lib advapi32.lib ws2_32.lib kernel32.lib user32.lib iphlpapi.lib /nologo /subsystem:console /incremental:no /debug /machine:I386 /out:"../bin/snmpd_d.exe" /pdbtype:sept /libpath:"../lib"
