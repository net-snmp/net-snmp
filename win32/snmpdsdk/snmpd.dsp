...
# ADD LINK32 netsnmpagent.lib netsnmpmibs.lib netsnmphelpers.lib libsnmp.lib msvcrt.lib Advapi32.lib wsock32.lib kernel32.lib user32.lib oldnames.lib /nologo /subsystem:console /machine:I386 /nodefaultlib /out:"../bin/snmpdsdk.exe" /libpath:"..\lib"
...
# ADD LINK32 netsnmpagent_d.lib netsnmpmibs_d.lib netsnmphelpers_d.lib snmp_d.lib libcmt.lib advapi32.lib shlwapi.lib wsock32.lib kernel32.lib user32.lib oldnames.lib /nologo /subsystem:console /incremental:no /debug /machine:I386 /nodefaultlib /out:"../bin/snmpdsdk_d.exe" /pdbtype:sept /libpath:"../lib"
