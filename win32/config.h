/* config.h:  currently this file has been manually constructed and included
              exclusively for the win32 build - in the future it would be
preferable to have this generated by 'configure' */
