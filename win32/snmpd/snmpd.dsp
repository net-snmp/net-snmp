...
# ADD LINK32 netsnmpagent_d.lib netsnmpmibs_d.lib netsnmphelpers_d.lib netsnmp_d.lib advapi32.lib ws2_32.lib kernel32.lib user32.lib /nologo /subsystem:console /incremental:no /debug /machine:I386 /out:"../bin/snmpd_d.exe" /pdbtype:sept /libpath:"../lib"
