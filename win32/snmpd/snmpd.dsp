...
# ADD LINK32 netsnmp.lib netsnmpagent.lib netsnmpmibs.lib netsnmphelpers.lib advapi32.lib wsock32.lib kernel32.lib user32.lib /nologo /subsystem:console /pdb:none /machine:I386 /out:"../bin/snmpd.exe" /libpath:"../lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /I "." /I ".." /I "..\..\snmplib" /I "..\.." /I "..\..\include" /I "..\..\agent" /I "..\..\agent\mibgroup" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "_NO_NETSNMP_DLL" /FR /YX /FD /c
...
# ADD LINK32 netsnmp_d.lib netsnmpagent_d.lib netsnmpmibs_d.lib netsnmphelpers_d.lib advapi32.lib wsock32.lib kernel32.lib user32.lib /nologo /subsystem:console /incremental:no /debug /machine:I386 /out:"../bin/snmpd_d.exe" /pdbtype:sept /libpath:"../lib"
