...
# ADD LINK32 netsnmp.lib msvcrt.lib advapi32.lib wsock32.lib kernel32.lib user32.lib oldnames.lib /nologo /subsystem:console /machine:I386 /nodefaultlib /out:"../bin/snmpbulkwalk.exe" /libpath:"..\lib"
...
# ADD LINK32 advapi32.lib netsnmp_d.lib libcmt.lib wsock32.lib kernel32.lib user32.lib oldnames.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib /out:"../bin/snmpbulkwalk_d.exe" /pdbtype:sept /libpath:"../lib"
