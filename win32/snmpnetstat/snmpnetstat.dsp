...
# ADD LINK32 netsnmp.lib advapi32.lib ws2_32.lib kernel32.lib user32.lib /nologo /subsystem:console /pdb:none /machine:I386 /out:"../bin/snmpnetstat.exe" /libpath:"../lib"
...
# ADD LINK32 netsnmp_d.lib advapi32.lib ws2_32.lib kernel32.lib user32.lib /nologo /subsystem:console /incremental:no /debug /machine:I386 /out:"../bin/snmpnetstat_d.exe" /pdbtype:sept /libpath:"../lib"
