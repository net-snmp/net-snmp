...
# ADD LINK32 advapi32.lib netsnmp.lib wsock32.lib msvcrt.lib kernel32.lib user32.lib oldnames.lib /nologo /subsystem:console /machine:I386 /nodefaultlib /out:"../bin/snmptranslate.exe" /libpath:"..\lib"
...
# ADD LINK32 netsnmp_d.lib wsock32.lib libcmt.lib kernel32.lib user32.lib oldnames.lib advapi32.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib /out:"../bin/snmptranslate_d.exe" /pdbtype:sept /libpath:"../lib"
