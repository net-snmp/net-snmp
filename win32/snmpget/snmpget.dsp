...
# ADD LINK32 netsnmp_d.lib advapi32.lib ws2_32.lib kernel32.lib user32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../bin/snmpget_d.exe" /pdbtype:sept /libpath:"../lib"
